...
import {
  ...
  s as ie,
  t as ae,
} from "./index-COdq92lb.js";
import { t as oe } from "./userAuthStore-BvaSD8Vv.js";
import { t as se } from "./BaseInput-Du-FuUXE.js";
import "./BaseInput-BLkxjht9.js";
import { t as ce } from "./workPackageStore-_rduQiQV.js";
import { t as le } from "./useIncrementalList-7z6ZpH37.js";
import { t as ue } from "./GalleryWorksSection--P8QSFcF.js";
import { t as de } from "./BaseTextArea-CPXr7NM1.js";
var fe = re(`camera`, [
    [
      `path`,
      {
  ...
  C = ee(`userProfile`, {
    ...
    getters: {
      ...
      getEditPrepareProfile: (e) => e.editPrepareProfile,
      getSelectedUserId: (e) => e.selectedUserId,
    },
    actions: {
      setUserProfile(e) {
        this.userProfile = e;
      },
      setEditPrepareProfile(e) {
        this.editPrepareProfile = { ...this.editPrepareProfile, ...e };
      },
      setSelectedUserId(e) {
  ...
  me = x({
    ...
    setup(e, { expose: t }) {
      ...
      let n = C(),
        ...
        a = e;
      i(async () => {
        r.value = n.getUserProfile;
      });
      let o = { userProfileStore: n, profile: r, props: a };
      return (
  ...
  return r.profile
    ? (c(),
      p(`div`, he, [
        f(`div`, ge, [
          f(`section`, _e, [
            f(`img`, { src: r.profile.iconUrl, class: `icon` }, null, 8, ve),
            f(`div`, ye, [
              f(`div`, be, o(r.profile.name), 1),
              f(`div`, xe, `@` + o(r.profile.userId), 1),
            ]),
          ]),
          f(`section`, Se, [
            (t[1] ||= f(`div`, { class: `title` }, o(`プロフィール`), -1)),
            f(`div`, Ce, [
              (t[0] ||= a(o(`自己紹介 :`) + ` `, -1)),
              f(`div`, we, o(r.profile.bio), 1),
              f(`div`, Te, [
                (c(!0),
                p(
                  h,
                    ...
                    (e) => (
                      ...
                      p(
                        ...
                        [
                          ...
                          f(`img`, { src: e.type, class: `icon` }, null, 8, Oe),
                          a(` ` + o(e.type), 1),
                        ],
                        8,
                        Ee,
              ...
              f(`div`, ke, [
                f(`span`, null, `📅 ` + o(r.profile.createdAt), 1),
                f(`span`, null, `📊 投稿数：` + o(r.profile.postCount), 1),
              ]),
            ]),
          ]),
        ]),
...
var Me = v(me, [
    ...
    [
      `__file`,
      `/Users/azumakoutaira/workspace/moti_nabi/frontend/src/features/profile/components/ProfileSection.vue`,
    ],
  ]),
  Ne = x({
    ...
    setup(e, { expose: t }) {
      t();
      let n = ce(),
        { userWorkPackageStoreGetter: r } = ne(n),
        { visibleItems: i, more: a } = le(r, 20),
        o = {
          workPackageStore: n,
          userWorkPackageStoreGetter: r,
          visibleItems: i,
          more: a,
          props: e,
          GalleryWorksSection: ue,
        };
      return (
        Object.defineProperty(o, "__isScriptSetup", {
          enumerable: !1,
  ...
  Pe = { class: `UserWorksPanel` };
function Fe(t, n, r, i, a, o) {
  return (
    c(),
    p(`div`, Pe, [
      e(
        i.GalleryWorksSection,
...
var Ie = v(Ne, [
  [`render`, Fe],
  [`__scopeId`, `data-v-a7eb62ef`],
  [
    `__file`,
    `/Users/azumakoutaira/workspace/moti_nabi/frontend/src/features/profile/components/UserWorksPanel.vue`,
  ],
]);
function Le(e, t) {
  var n = Object.keys(e);
...
function We(e, t) {
  ...
  return (
    e && t
      ? ((n = `` + e + t[0].toUpperCase() + t.slice(1)), (r = e + `-` + t))
      : ((n = e || t), (r = e || t)),
    { name: n, classname: r }
  );
}
      ...
      (e.prototype.shift = function () {
        ...
        if (t) {
          var i = t.getBoundingClientRect(),
            a = i.left,
            o = i.top;
          return { left: r.left - a - n.left, top: r.top - o - n.top };
        }
        return { left: 0, top: 0 };
      }),
      e
  ...
  et = {
    ...
    methods: {
      ...
      onMouseLeave: function () {
        this.hovered &&
          !this.touches.length &&
          ((this.hovered = !1), this.$emit(`leave`));
      },
      onTouchStart: function (e) {
        e.cancelable &&
          !this.disabled &&
          e.touches.length === 1 &&
          ((this.touches = E(e.touches)),
          (this.hovered ||= (this.$emit(`enter`), !0)),
          e.touches.length &&
            this.initAnchor(
              this.touches.reduce(
                function (t, n) {
      ...
      onMouseMove: function (e) {
        this.touches.length &&
          (this.processMove(e, [
            { fake: !0, clientX: e.clientX, clientY: e.clientY },
          ]),
          e.preventDefault && e.preventDefault());
      },
      onMouseUp: function () {
      ...
      processEnd: function () {
        (this.touches.length && this.$emit(`drag-end`),
          (this.hovered &&= (this.$emit(`leave`), !1)),
          (this.touches = []));
      },
    },
    emits: [`drag`, `drag-end`, `leave`, `enter`],
  };
et.render = function (e, t, n, r, i, a) {
  return (
    c(),
    b(
      `div`,
...
var tt = k(`vue-handler-wrapper`),
  nt = {
    name: `HandlerWrapper`,
    components: { DraggableElement: et },
    props: {
    ...
    computed: {
      classes: function () {
        ...
        if (this.horizontalPosition || this.verticalPosition) {
          var t,
            n = We(this.horizontalPosition, this.verticalPosition);
          e = tt(
            (T((t = {}), n.classname, !0), T(t, `disabled`, this.disabled), t),
          );
        } else e = tt({ disabled: this.disabled });
        return { root: e, draggable: tt(`draggable`) };
      },
    },
    emits: [`leave`, `enter`, `drag`, `drag-end`],
  };
nt.render = function (n, r, i, a, o, s) {
  var u = t(`DraggableElement`);
  return (
    c(),
    b(
      `div`,
      ...
      [
        e(
          u,
          {
            ...
            onDrag: (r[1] ||= function (e) {
              return n.$emit(`drag`, e);
            }),
            onDragEnd: (r[2] ||= function (e) {
              return n.$emit(`drag-end`);
            }),
            onLeave: (r[3] ||= function (e) {
              return n.$emit(`leave`);
            }),
            onEnter: (r[4] ||= function (e) {
              return n.$emit(`enter`);
            }),
          },
          {
            default: d(function () {
              return [l(n.$slots, `default`)];
            }),
            _: 3,
          },
          8,
  ...
  it = {
    ...
    computed: {
      classname: function () {
        var e;
        return rt(
          (T((e = {}), this.position, !0), T(e, `disabled`, this.disabled), e),
        );
      },
    },
    emits: [`leave`, `enter`, `drag`, `drag-end`],
  };
it.render = function (e, n, r, i, a, o) {
  var s = t(`DraggableElement`);
  return (
    c(),
    b(
      s,
      {
        class: o.classname,
        onDrag: (n[1] ||= function (t) {
          return e.$emit(`drag`, t);
        }),
        onDragEnd: (n[2] ||= function (t) {
          return e.$emit(`drag-end`);
        }),
        onLeave: (n[3] ||= function (t) {
          return e.$emit(`leave`);
        }),
        onEnter: (n[4] ||= function (t) {
          return e.$emit(`enter`);
        }),
      },
      {
...
var I = [`left`, `right`, `top`, `bottom`],
  ...
  ot = [`top`, `bottom`],
  st = [`left`, `top`],
  ct = [`fill-area`, `fit-area`, `stencil`, `none`],
  lt = { left: 0, top: 0, width: 0, height: 0 };
function ut(e, t, n) {
  return !(n ||= [`width`, `height`, `left`, `top`]).some(function (n) {
    return e[n] !== t[n];
  });
}
function L(e) {
...
function U(e, t) {
  return A(A({}, e), { left: e.left + t.left, top: e.top + t.top });
}
function W(e, t, n, r) {
  if (t !== 1) {
    if (n) {
      ...
      return {
        ...
        height: e.height * t,
        left:
          e.left + (e.width * (1 - t)) / 2 + (n.left - i.left) * (r || 1 - t),
...
function K(e, t) {
  return Math.min(
    t.right !== void 0 && t.left !== void 0
      ? (t.right - t.left) / e.width
      : 1 / 0,
    t.bottom !== void 0 && t.top !== void 0
...
function q(e, t) {
  ...
  return (
    r.left && r.left > 0
      ? (n.left = r.left)
      : r.right && r.right > 0 && (n.left = -r.right),
    r.top && r.top > 0
      ? (n.top = r.top)
      : r.bottom && r.bottom > 0 && (n.top = -r.bottom),
    n
  );
}
function dt(e, t) {
  var n;
  return (
    t.minimum && e < t.minimum
      ? (n = t.minimum)
      : t.maximum && e > t.maximum && (n = t.maximum),
    n
  );
}
function ft(e, t) {
...
function Y(e, t) {
  ...
  return n.left + n.right + n.top + n.bottom
    ? n.left + n.right > n.top + n.bottom
      ? Math.min((e.width + n.left + n.right) / e.width, K(e, t))
      : Math.min((e.height + n.top + n.bottom) / e.height, K(e, t))
    : 1;
}
function X(e, t, n) {
  n === void 0 && (n = !1);
...
function _t(e) {
  ...
  return !!(
    (t.correctRatio || (G(t) >= n.minimum && G(t) <= n.maximum)) &&
    t.height <= i.maxHeight &&
    t.width <= i.maxWidth &&
    t.width &&
    t.height &&
    (r || (t.height >= i.minHeight && t.width >= i.minWidth))
  );
}
function vt(e, t) {
...
function Q(e) {
    ...
    return (
      ...
      e.reduce(function (e, o) {
        return _t({
          ...
          (!e ||
            vt(o, { width: t, height: n }) < vt(e, { width: t, height: n }))
          ? o
          : e;
      }, null)
    );
  ...
  var s = [];
  (i &&
    [i.minimum, i.maximum].forEach(function (e) {
      e &&
        s.push(
          { width: a.width, height: a.width / e, correctRatio: !0 },
          { width: a.height * e, height: a.height, correctRatio: !0 },
        );
    }),
    _t({ size: a, aspectRatio: i, sizeRestrictions: r }) && s.push(a));
  var c = o(s) || o(s, !0);
  ...
  var t = e.coordinates,
    ...
    c = function (e, t) {
      return yt({
        ...
        event: new Qe({ left: t.left - e.left, top: t.top - e.top }),
      });
    },
    l = A({}, t);
  return (
    (Array.isArray(n) ? n : [n]).forEach(function (e) {
      ...
      ((M(
        (t =
          typeof e == `function`
            ? e({ coordinates: l, imageSize: r, visibleArea: s })
            : e).width,
      ) &&
        M(t.height)) ||
        (l = (function (e, t) {
        ...
        (M(t.left) && M(t.top)) || (l = c(l, A(A({}, l), t))));
    }),
    l
  );
}
function xt(e) {
  ...
  ((c = G(p)),
    ...
    (c === 0 || l === 0
      ? Math.abs(l - c) < u
      : Math.abs(l / c) < 1 + u && Math.abs(l / c) > 1 - u) ||
      (d = A(
        A({}, d),
        Q({
          sizeRestrictions: o,
          width: d.width,
          height: d.height,
          aspectRatio: { minimum: G(p), maximum: G(p) },
        }),
      )));
  var m = Y(
    (f = W(f, (d.width * n.width) / (f.width * p.width))),
    t({ visibleArea: f, type: `resize` }),
  );
  return (
    m !== 1 && ((f = W(f, m)), (d = W(d, m))),
    (f = X((f = U(f, R(z(d), z(f)))), t({ visibleArea: f, type: `move` }))),
    { coordinates: (d = X(d, Z(L(f), s))), visibleArea: f }
  );
}
function St(e) {
  var t = e.event,
  ...
  if (i && a && t.type !== `manipulateImage`) {
    ...
    (c.width,
      r.width,
      G(r) > G(s)
        ? ((l.height = 0.8 * r.height), (l.width = l.height * G(s)))
        : ((l.width = 0.8 * r.width), (l.height = l.width * G(s))));
    var u = Y(
      (c = W(c, (s.width * r.width) / (c.width * l.width))),
      n({ visibleArea: c, type: `resize` }),
    );
    ((c = W(c, u)),
      u !== 1 && ((l.height /= u), (l.width /= u)),
      (c = X((c = U(c, R(z(s), z(c)))), n({ visibleArea: c, type: `move` }))),
      (s = X(s, Z(L(c), o))));
  }
  return { coordinates: s, visibleArea: c };
}
function Ct(e) {
  var t = e.event,
    n = e.coordinates,
    r = e.visibleArea,
    i = e.getAreaRestrictions,
    a = A({}, r),
    o = A({}, n);
  if (t.type === `setCoordinates`) {
    var s = Math.max(0, o.width - a.width),
      c = Math.max(0, o.height - a.height);
    (s > c
      ? (a = W(
          a,
          Math.min(
            o.width / a.width,
            K(a, i({ visibleArea: a, type: `resize` })),
          ),
        ))
      : c > s &&
        (a = W(
      ...
      (a = X((a = U(a, H(q(o, L(a))))), i({ visibleArea: a, type: `move` }))));
  }
...
function Tt(e) {
  var t = e.imageSize,
    ...
    i = e.sizeRestrictions,
    a = n || t,
    o = Math.min(r.maximum || 1 / 0, Math.max(r.minimum || 0, G(a))),
    s =
      a.width < a.height
        ? { width: 0.8 * a.width, height: (0.8 * a.width) / o }
        : { height: 0.8 * a.height, width: 0.8 * a.height * o };
  return Q(A(A({}, s), { aspectRatio: r, sizeRestrictions: i }));
}
function Et(e) {
  var t,
    n,
  ...
  return (
    G(l) > G(a)
      ? (n = (t = (c.height * l.height) / a.height) * G(c))
      : (t = (n = (c.width * l.width) / a.width) / G(c)),
    Q({ width: n, height: t, aspectRatio: o, sizeRestrictions: s })
  );
}
function Dt(e) {
  var t = e.getAreaRestrictions,
  ...
  if (n) {
    var a = {
      ...
      o = ft(
        {
          width: G(a) > i ? a.width : a.height * i,
          height: G(a) > i ? a.width / i : a.height,
        },
        mt(t()),
      ),
      s = {
      ...
      c = B(n, L(A({ left: 0, top: 0 }, r))),
      l = {};
    return (
      !c.left &&
        !c.right &&
        s.width <= r.width &&
        ((l.left = 0), (l.right = r.width)),
      !c.top &&
        !c.bottom &&
        s.height <= r.height &&
        ((l.top = 0), (l.bottom = r.height)),
      X(s, l)
    );
  }
  var u = G(r);
...
function kt(e) {
  var t = e.event,
    ...
    f = 1,
    p = 1,
    m = c.factor && Math.abs(c.factor - 1) > 0.001;
  u = U(u, { left: l.left || 0, top: l.top || 0 });
  var h = {
    stencil: {
      minimum: Math.max(
        i.minWidth ? i.minWidth / d.width : 0,
        i.minHeight ? i.minHeight / d.height : 0,
      ),
      maximum: Math.min(
        i.maxWidth ? i.maxWidth / d.width : 1 / 0,
        i.maxHeight ? i.maxHeight / d.height : 1 / 0,
        K(d, o),
      ),
    },
    area: { maximum: K(u, a({ visibleArea: u, type: `resize` })) },
  };
  (c.factor &&
    m &&
    (c.factor < 1
      ? (p = Math.max(c.factor, h.stencil.minimum)) > 1 && (p = 1)
      : c.factor > 1 &&
        (p = Math.min(c.factor, Math.min(h.area.maximum, h.stencil.maximum))) <
          1 &&
        (p = 1)),
    p && (u = W(u, p, c.center)));
  var g = n.left - r.left,
    _ = r.width + r.left - (n.width + n.left),
    v = n.top - r.top,
    y = r.height + r.top - (n.height + n.top);
  return (
    (u = X(
      (u = U(
        u,
    ...
    c.factor &&
      ...
      s &&
      (c.factor > 1
        ? (f = Math.min(h.area.maximum, c.factor) / p)
        : c.factor < 1 &&
          (f = Math.max(d.height / u.height, d.width / u.width, c.factor / p)),
      f !== 1 &&
        (u = U(
          (u = X(
            (u = W(u, f, c.factor > 1 ? c.center : z(d))),
            a({ visibleArea: u, type: `move` }),
          )),
          H(q(d, L(u))),
        ))),
    { coordinates: d, visibleArea: u }
  );
}
function At(e) {
  var t = e.aspectRatio,
    ...
    o = e.positionRestrictions,
    s = e.imageSize,
    c = e.previousImageSize,
    l = e.angle,
    u = A({}, r),
    d = A({}, i),
    f = J(z(A({ left: 0, top: 0 }, c)), l);
  return (
    ((u = A(
      A(
        {},
      ...
      J(z(u), l),
    )).left -= f.left - s.width / 2 + u.width / 2),
    (u.top -= f.top - s.height / 2 + u.height / 2),
    (d = W(d, Y(d, n({ visibleArea: d, type: `resize` })))),
    {
      coordinates: (u = X(u, o)),
      visibleArea: (d = X(
        (d = U(d, R(z(u), z(r)))),
        n({ visibleArea: d, type: `move` }),
      )),
    }
  );
}
function jt(e) {
  var t = e.flip,
    ...
    r = e.rotate;
  e.aspectRatio;
  var i = e.getAreaRestrictions,
    a = e.coordinates,
    o = e.visibleArea,
    s = e.imageSize,
    c = A({}, a),
    l = A({}, o),
    u = n.horizontal !== t.horizontal,
    d = n.vertical !== t.vertical;
  if (u || d) {
    var f = J({ left: s.width / 2, top: s.height / 2 }, -r),
      p = J(z(c), -r),
      m = J(
        {
    ...
    ((c = U(c, R(m, z(c)))),
      ...
      (l = X(
        ...
        i({ visibleArea: l, type: `move` }),
      )));
  }
  return { coordinates: c, visibleArea: l };
}
function Mt(e) {
  var t = e.directions,
    n = e.coordinates,
  ...
  (l < 0 &&
    (c.left < 0 && c.right < 0
      ? ((c.left = -(n.width - a.minWidth) / (c.left / c.right)),
        (c.right = -(n.width - a.minWidth) / (c.right / c.left)))
      : c.left < 0
        ? (c.left = -(n.width - a.minWidth))
        : c.right < 0 && (c.right = -(n.width - a.minWidth))),
    u < 0 &&
      (c.top < 0 && c.bottom < 0
        ? ((c.top = -(n.height - a.minHeight) / (c.top / c.bottom)),
          (c.bottom = -(n.height - a.minHeight) / (c.bottom / c.top)))
        : c.top < 0
          ? (c.top = -(n.height - a.minHeight))
          : c.bottom < 0 && (c.bottom = -(n.height - a.minHeight))));
  var d = B(V(n, c), i);
  s &&
    (d.left && d.left > 0 && d.right === 0
      ? ((c.right += d.left), (c.left -= d.left))
      : d.right &&
        d.right > 0 &&
        d.left === 0 &&
        ((c.left += d.right), (c.right -= d.right)),
    d.top && d.top > 0 && d.bottom === 0
      ? ((c.bottom += d.top), (c.top -= d.top))
      : d.bottom &&
        d.bottom > 0 &&
        d.top === 0 &&
        ((c.top += d.bottom), (c.bottom -= d.bottom)),
    (d = B(V(n, c), i)));
  var f = {
    width: 1 / 0,
    height: 1 / 0,
  ...
  if (
    ...
    c.right + c.left &&
      (l > a.maxWidth
        ? (f.width = (a.maxWidth - n.width) / (c.right + c.left))
        : l < a.minWidth &&
          (f.width = (a.minWidth - n.width) / (c.right + c.left))),
    c.bottom + c.top &&
      (u > a.maxHeight
        ? (f.height = (a.maxHeight - n.height) / (c.bottom + c.top))
        : u < a.minHeight &&
          (f.height = (a.minHeight - n.height) / (c.bottom + c.top))),
    o)
  ) {
...
var Pt = k(`vue-simple-handler`),
  Ft = k(`vue-simple-handler-wrapper`),
  It = {
    name: `SimpleHandler`,
    components: { HandlerWrapper: nt },
    props: {
    ...
    computed: {
      classes: function () {
        var e,
          t =
            (T((e = {}), this.horizontalPosition, !!this.horizontalPosition),
            T(e, this.verticalPosition, !!this.verticalPosition),
            T(
              e,
              `${this.horizontalPosition}-${this.verticalPosition}`,
              !!(this.verticalPosition && this.horizontalPosition),
            ),
            T(e, `hover`, this.hover),
            e);
        return {
          default: O(Pt(t), this.defaultClass, this.hover && this.hoverClass),
          wrapper: O(Ft(t), this.wrapperClass),
        };
      },
    },
    methods: {
...
It.render = function (n, r, i, a, o, s) {
  var l = t(`HandlerWrapper`);
  return (
    c(),
    b(
      l,
      {
        ...
        "vertical-position": i.verticalPosition,
        "horizontal-position": i.horizontalPosition,
        disabled: i.disabled,
        onDrag: s.onDrag,
      ...
      {
        default: d(function () {
          return [e(`div`, { class: s.classes.default }, null, 2)];
        }),
        _: 1,
      },
      8,
...
var Lt = k(`vue-simple-line`),
  Rt = k(`vue-simple-line-wrapper`),
  zt = {
    name: `SimpleLine`,
    components: { LineWrapper: it },
    props: {
      defaultClass: { type: String },
      hoverClass: { type: String },
      wrapperClass: { type: String },
    ...
    computed: {
      classes: function () {
        return {
          root: O(
            Lt(T({}, this.position, !0)),
            this.defaultClass,
            this.hover && this.hoverClass,
          ),
          wrapper: O(Rt(T({}, this.position, !0)), this.wrapperClass),
        };
      },
    },
    methods: {
...
zt.render = function (n, r, i, a, o, s) {
  var l = t(`LineWrapper`);
  return (
    c(),
    b(
      ...
      {
        default: d(function () {
          return [e(`div`, { class: s.classes.root }, null, 2)];
        }),
        _: 1,
      },
      8,
  ...
  Ut = {
        ...
        return (
          this.width &&
            ...
            this.transitions &&
              ...
              (e.transition = `${this.transitions.time}ms ${this.transitions.timingFunction}`)),
          e
        );
      },
      classes: function () {
          ...
          this.points.forEach(function (i) {
            if (e.handlers[i.name]) {
              var a = {
                ...
                class: O(
                  e.classes.handlers.default,
                  e.classes.handlers[i.name],
                ),
                wrapperClass: O(
                  e.classes.handlersWrappers.default,
                  e.classes.handlersWrappers[i.name],
                ),
              ...
              if (n && r) {
                var o = i.horizontalDirection,
                  s = i.verticalDirection,
                  c = o === `east` ? n : o === `west` ? 0 : n / 2,
                  l = s === `south` ? r : s === `north` ? 0 : r / 2;
                ((a.wrapperClass = Bt(`handler`)),
                  (a.wrapperStyle = { transform: `translate(${c}px, ${l}px)` }),
                  e.transitions &&
                    e.transitions.enabled &&
                    (a.wrapperStyle.transition = `${e.transitions.time}ms ${e.transitions.timingFunction}`));
              } else a.wrapperClass = Bt(`handler`, T({}, i.classname, !0));
              t.push(a);
            }
          }),
          t
    ...
    methods: {
      ...
      onHandlerDrag: function (e, t, n) {
        ...
        (t === `west` ? (s.left -= a) : t === `east` && (s.right += a),
          n === `north` ? (s.top -= o) : n === `south` && (s.bottom += o),
          !n && t ? (r = `width`) : n && !t && (r = `height`),
          this.resizable &&
            this.$emit(
              `resize`,
              new Ze(s, {
...
Ut.render = function (t, r, i, a, o, u) {
  return (
    c(),
    b(
      `div`,
      { ref: `box`, class: u.classes.root, style: u.style },
      [
        l(t.$slots, `default`),
        e(`div`, null, [
          (c(!0),
...
Gt.render = function (e, t, n, r, i, a) {
  return (
    c(),
    b(
      `div`,
      ...
      if (e)
        if (/^data:/i.test(e))
          ...
          ((i.onreadystatechange = function () {
            i.readyState === 4 &&
              (i.status === 200 || i.status === 0
                ? t(i.response)
                : n(
                    `Warning: could not load an image to parse its orientation`,
                  ),
              (i = null));
          }),
...
function Jt(e) {
  ...
  return (
    (a += ` rotate(` + t + `deg) `),
    (a += ` scaleX(` + r * (n.horizontal ? -1 : 1) + `) `),
    (a += ` scaleY(` + i * (n.vertical ? -1 : 1) + `) `)
  );
}
function Yt(e) {
  try {
    ...
    if (n.getUint8(0) === 255 && n.getUint8(1) === 216)
      for (var s = n.byteLength, c = 2; c + 1 < s; ) {
    ...
    if (o) {
      for (var d = n.getUint16(o, i), f = 0; f < d; f++)
        if (((c = o + 12 * f + 2), n.getUint16(c, i) === 274)) {
    ...
    computed: {
      classes: function () {
        return {
          ...
          image: O(Xt(`image`), this.imageClass),
        };
      },
      ...
      imageStyle: function () {
        ...
        return (
          (n.transform =
            `translate(
				${-this.stencilCoordinates.left - e.translateX - r.left - i.left}px,${-this.stencilCoordinates.top - e.translateY - r.top - i.top}px) ` +
            Jt(e)),
          this.transitions &&
            this.transitions.enabled &&
            (n.transition = `${this.transitions.time}ms ${this.transitions.timingFunction}`),
          n
        );
      },
    },
...
function Qt(e, t) {
  ...
  return (
    e.forEach(function (t) {
      ((a.left += (t.clientX - r) / e.length),
        (a.top += (t.clientY - i) / e.length));
    }),
    e.forEach(function (e) {
      o += Xe({ x: a.left, y: a.top }, { x: e.clientX - r, y: e.clientY - i });
    }),
    { centerMass: a, spread: o, count: e.length }
  );
}
Zt.render = function (t, n, r, i, a, o) {
  return (
    c(),
    b(
      `div`,
      ...
      [
        e(
          `div`,
          { ref: `wrapper`, class: o.classes.wrapper, style: o.wrapperStyle },
          [
            e(
              `img`,
              {
...
var $t = {
  ...
  created: function () {
    ((this.transforming = !1),
      (this.debouncedProcessEnd = Ue(this.processEnd)),
      (this.touches = []));
  },
  methods: {
    processMove: function (e, t) {
      if (this.touches.length) {
        if (this.touches.length === 1 && t.length === 1)
          ...
          var n = Qt(t, this.$refs.container),
            r = this.oldGeometricProperties;
          (r.count === n.count &&
            r.count > 1 &&
            this.$emit(
              `resize`,
              new F(
                ...
                { factor: r.spread / n.spread, center: n.centerMass },
              ),
            ),
    ...
    processEnd: function () {
      this.transforming &&
        ((this.transforming = !1), this.$emit(`transform-end`));
    },
    ...
    processEvent: function (e) {
      return this.eventsFilter
        ? !1 !== this.eventsFilter(e, this.transforming)
    ...
    onTouchStart: function (e) {
      if (
        ...
        var t = this.$refs.container,
          ...
          a = n.bottom,
          o = n.right;
        ((this.touches = E(e.touches).filter(function (e) {
          return (
            e.clientX > r && e.clientX < o && e.clientY > i && e.clientY < a
          );
        })),
          (this.oldGeometricProperties = Qt(this.touches, t)));
      }
    },
    ...
    onTouchMove: function (e) {
      var t = this;
      if (this.touches.length) {
        var n = E(e.touches).filter(function (e) {
          return (
            !e.identifier ||
            t.touches.find(function (t) {
        ...
        var t = this.$refs.container.getBoundingClientRect(),
          ...
          i =
            ...
            this.wheelResize.ratio *
              ((o = e.deltaY || e.detail || e.wheelDelta),
              (s = +o) == 0 || Ye(s) ? s : s > 0 ? 1 : -1),
          a = { left: e.clientX - n, top: e.clientY - r };
        (this.$emit(`resize`, new F({}, { factor: i, center: a })),
...
var en = {
  components: { TransformableImage: $t },
  props: {
    touchMove: { type: Boolean, required: !0 },
    mouseMove: { type: Boolean, required: !0 },
    touchResize: { type: Boolean, required: !0 },
...
en.render = function (e, n, r, i, a, o) {
  var s = t(`transformable-image`);
  return (
    c(),
    b(
      s,
      {
        ...
        onMove: (n[1] ||= function (t) {
          return e.$emit(`move`, t);
        }),
        onResize: (n[2] ||= function (t) {
...
var tn = k(`vue-preview`),
  nn = {
    ...
    computed: {
      classes: function () {
        return {
          root: tn({ fill: this.fill }),
          wrapper: tn(`wrapper`),
          imageWrapper: tn(`image-wrapper`),
          image: O(tn(`image`), this.imageClass),
        };
      },
      style: function () {
        if (this.fill) return {};
        var e = {};
        return (
          this.width && (e.width = `${this.size.width}px`),
          this.height && (e.height = `${this.size.height}px`),
          this.transitions &&
            this.transitions.enabled &&
            (e.transition = `${this.transitions.time}ms ${this.transitions.timingFunction}`),
          e
      ...
      imageStyle: function () {
        if (this.coordinates && this.image) {
          var e = this.coordinates.width / this.size.width,
            t = w(
              w(
                { rotate: 0, flip: { horizontal: !1, vertical: !1 } },
            ...
            r = this.imageSize.height,
            i = pt({ width: n, height: r }, t.rotate),
            a = { width: `${n}px`, height: `${r}px`, left: `0px`, top: `0px` },
            o = {
              rotate: {
          ...
          return (
            (a.transform =
              `translate(
				${-this.coordinates.left / e - o.rotate.left - o.scale.left}px,${-this.coordinates.top / e - o.rotate.top - o.scale.top}px) ` +
              Jt(t)),
            this.transitions &&
              this.transitions.enabled &&
              (a.transition = `${this.transitions.time}ms ${this.transitions.timingFunction}`),
            a
          );
        }
        return {};
...
nn.render = function (t, n, i, a, o, s) {
  return (
    c(),
    b(
      `div`,
      { ref: `root`, class: s.classes.root, style: s.style },
      [
        e(
          `div`,
          { ref: `wrapper`, class: s.classes.wrapper, style: s.wrapperStyle },
          [
            r(
              e(
                `img`,
...
var rn = { components: { Preview: nn }, inheritAttrs: !1 };
rn.render = function (e, n, r, i, a, o) {
  var s = t(`preview`);
  return (c(), b(s, g(e.$attrs, { fill: !0 }), null, 16));
};
var an = k(`vue-rectangle-stencil`),
  on = {
    name: `RectangleStencil`,
    components: { StencilPreview: rn, BoundingBox: Ut, DraggableArea: Gt },
    props: {
      image: { type: Object },
      coordinates: { type: Object },
    ...
    computed: {
      classes: function () {
        return {
          ...
          preview: O(an(`preview`), this.previewClass),
          boundingBox: O(an(`bounding-box`), this.boundingBoxClass),
        };
      },
      style: function () {
...
on.render = function (n, r, i, a, o, s) {
  var l = t(`stencil-preview`),
    u = t(`draggable-area`),
    f = t(`bounding-box`);
  return (
    c(),
    b(
      `div`,
      { class: s.classes.stencil, style: s.style },
      [
        e(
          f,
          {
            width: i.stencilCoordinates.width,
            height: i.stencilCoordinates.height,
            transitions: i.transitions,
            class: s.classes.boundingBox,
            handlers: i.handlers,
            "handlers-component": i.handlersComponent,
            "handlers-classes": i.handlersClasses,
            "handlers-wrappers-classes": i.handlersWrappersClasses,
            lines: i.lines,
            "lines-component": i.linesComponent,
            "lines-classes": i.linesClasses,
            "lines-wrappers-classes": i.linesWrappersClasses,
    ...
    computed: {
      classes: function () {
        return {
          ...
          preview: O(sn(`preview`), this.previewClass),
          boundingBox: O(sn(`bounding-box`), this.boundingBoxClass),
        };
      },
      style: function () {
        var e = this.stencilCoordinates,
...
cn.render = function (n, r, i, a, o, s) {
  var l = t(`stencil-preview`),
    u = t(`draggable-area`),
    f = t(`bounding-box`);
  return (
...
var ln = [`transitions`],
  $ = k(`vue-advanced-cropper`),
  un = {
    name: `Cropper`,
    components: { BackgroundWrapper: en },
    props: {
      ...
      resizeAlgorithm: {
        ...
        default: function (e) {
          var t = e.event,
            ...
            s = t.params || {},
            c = A({}, t.directions),
            l = s.allowedDirections || {
              left: !0,
              right: !0,
              bottom: !0,
              top: !0,
            };
          (a.widthFrozen && ((c.left = 0), (c.right = 0)),
            a.heightFrozen && ((c.top = 0), (c.bottom = 0)),
            I.forEach(function (e) {
              l[e] || (c[e] = 0);
            }));
          var u = V(
            ...
            d = V(o, c).height,
            f = s.preserveRatio ? G(o) : dt(u / d, r);
          if (f) {
            var p = s.respectDirection;
            if (
              ((p ||= o.width >= o.height || f === 1 ? `width` : `height`),
              p === `width`)
            ) {
              var m = u / f - o.height;
              if (l.top && l.bottom) {
                var h = c.top,
                  g = c.bottom;
                ((c.bottom = Nt(m, g, h)), (c.top = Nt(m, h, g)));
              } else
                l.bottom
                  ? (c.bottom = m)
                  : l.top
              ...
              if (l.left && l.right) {
                var v = c.left,
                  y = c.right;
                ((c.left = -Nt(_, v, y)), (c.right = -Nt(_, y, v)));
              } else
                l.left
                  ? (c.left = -_)
                  : l.right
          ...
          return (
            ...
            (d = V(o, c).height),
            (f = s.preserveRatio ? G(o) : dt(u / d, r)) &&
              Math.abs(f - u / d) > 0.001 &&
              I.forEach(function (e) {
                l[e] || (c[e] = 0);
              }),
            yt({
              event: new Qe({ left: -c.left, top: -c.top }),
              coordinates: {
      ...
      moveAlgorithm: { type: Function, default: yt },
      initStretcher: {
        type: Function,
        default: function (e) {
          var t = e.stretcher,
          ...
          ((t.style.width = n.width + `px`),
            (t.style.height = t.clientWidth / r + `px`),
      ...
      fitCoordinates: {
        ...
        default: function (e) {
          ...
          return (o = X((o = U(o, R(z(n), z(o)))), Z(L(t), a)));
        },
      },
      fitVisibleArea: {
        type: Function,
        default: function (e) {
          var t = e.visibleArea,
            ...
            i = e.coordinates,
            a = A({}, t);
          ((a.height = a.width / G(n)),
            (a.top += (t.height - a.height) / 2),
            (i.height - a.height > 0 || i.width - a.width > 0) &&
              (a = W(a, Math.max(i.height / a.height, i.width / a.width))));
          var o = H(
            q(i, L((a = W(a, Y(a, r({ visibleArea: a, type: `resize` })))))),
          );
          return (
            a.width < i.width && (o.left = 0),
            a.height < i.height && (o.top = 0),
            (a = X((a = U(a, o)), r({ visibleArea: a, type: `move` })))
          );
        },
      },
      areaRestrictionsAlgorithm: {
        ...
        default: function (e) {
          var t = e.visibleArea,
            n = e.boundaries,
            r = e.imageSize,
            i = e.imageRestriction,
            a = e.type,
            o = {};
          return (
            i === `fill-area`
              ? (o = { left: 0, top: 0, right: r.width, bottom: r.height })
              : i === `fit-area` &&
                (G(n) > G(r)
                  ? ((o = { top: 0, bottom: r.height }),
                    t &&
                      a === `move` &&
                      (t.width > r.width
                        ? ((o.left = -(t.width - r.width) / 2),
                          (o.right = r.width - o.left))
                        : ((o.left = 0), (o.right = r.width))))
                  : ((o = { left: 0, right: r.width }),
                    t &&
                      a === `move` &&
                      (t.height > r.height
                        ? ((o.top = -(t.height - r.height) / 2),
                          (o.bottom = r.height - o.top))
                        : ((o.top = 0), (o.bottom = r.height))))),
            o
          );
        },
      },
    ...
    computed: {
      ...
      imageTransforms: function () {
        return {
          ...
          translateX: this.visibleArea
            ? this.visibleArea.left / this.coefficient
            : 0,
          translateY: this.visibleArea
            ? this.visibleArea.top / this.coefficient
            : 0,
      ...
      coefficient: function () {
        return this.visibleArea
          ? this.visibleArea.width / this.boundaries.width
          : 0;
      },
      ...
      sizeRestrictions: function () {
        if (
          ...
          var e = this.sizeRestrictionsAlgorithm({
            imageSize: this.imageSize,
            minWidth: M(this.minWidth) ? 0 : P(this.minWidth),
            minHeight: M(this.minHeight) ? 0 : P(this.minHeight),
            maxWidth: M(this.maxWidth) ? 1 / 0 : P(this.maxWidth),
            maxHeight: M(this.maxHeight) ? 1 / 0 : P(this.maxHeight),
          });
          if (
            ((e = (function (e) {
              var t = e.areaRestrictions,
                n = e.sizeRestrictions;
              e.imageSize;
              var r = e.boundaries,
                i = e.positionRestrictions;
              e.imageRestriction;
              var a = A(A({}, n), {
                ...
                maxWidth: n.maxWidth === void 0 ? 1 / 0 : n.maxWidth,
                maxHeight: n.maxHeight === void 0 ? 1 / 0 : n.maxHeight,
              });
              (i.left !== void 0 &&
                i.right !== void 0 &&
                (a.maxWidth = Math.min(a.maxWidth, i.right - i.left)),
                i.bottom !== void 0 &&
                  i.top !== void 0 &&
                  (a.maxHeight = Math.min(a.maxHeight, i.bottom - i.top)));
              var o = mt(t),
                s = ft(r, o);
              return (
                o.width < 1 / 0 &&
                  (!a.maxWidth || a.maxWidth > s.width) &&
                  (a.maxWidth = Math.min(a.maxWidth, s.width)),
                o.height < 1 / 0 &&
                  (!a.maxHeight || a.maxHeight > s.height) &&
                  (a.maxHeight = Math.min(a.maxHeight, s.height)),
                a.minWidth > a.maxWidth &&
                  ((a.minWidth = a.maxWidth), (a.widthFrozen = !0)),
                a.minHeight > a.maxHeight &&
                  ((a.minHeight = a.maxHeight), (a.heightFrozen = !0)),
                a
              );
            })({
              sizeRestrictions: e,
            ...
            ((e.maxWidth = Math.min(
              e.maxWidth,
              (n.width * t.width) / this.boundaries.width,
            )),
      ...
      classes: function () {
        return {
          cropper: $(),
          image: O($(`image`), this.imageClass),
          stencil: $(`stencil`),
          boundaries: O($(`boundaries`), this.boundariesClass),
          stretcher: O($(`stretcher`)),
          background: O($(`background`), this.backgroundClass),
          foreground: O($(`foreground`), this.foregroundClass),
          imageWrapper: O($(`image-wrapper`)),
          cropperWrapper: O($(`cropper-wrapper`)),
        };
      },
      ...
      boundariesStyle: function () {
        var e = {
          width: this.boundaries.width
            ? `${Math.round(this.boundaries.width)}px`
            : `auto`,
          height: this.boundaries.height
            ? `${Math.round(this.boundaries.height)}px`
            : `auto`,
      ...
      imageStyle: function () {
        var e =
          ...
          r = w(
            w({}, this.imageTransforms),
            {},
            {
              scaleX:
                this.imageTransforms.scaleX *
                (this.imageAttributes.width / e.width),
              scaleY:
                this.imageTransforms.scaleY *
                (this.imageAttributes.height / e.height),
            },
          ),
          i = {
            width: `${e.width}px`,
            ...
            top: `0px`,
            transform:
              `translate(${-t.left - n.left - this.imageTransforms.translateX}px, ${-t.top - n.top - this.imageTransforms.translateY}px)` +
              Jt(r),
          };
        return (
          this.transitionsOptions.enabled &&
            (i.transition = `${this.transitionsOptions.time}ms ${this.transitionsOptions.timingFunction}`),
          i
        );
      },
    },
    ...
    created: function () {
      ((this.debouncedUpdate = Ue(this.update, this.debounce)),
        (this.debouncedDisableTransitions = Ue(
    ...
    methods: {
      getResult: function () {
        var e = this.initialized
            ? this.prepareResult(w({}, this.coordinates))
            : this.defaultCoordinates(),
          t = {
            rotate: this.imageTransforms.rotate % 360,
            flip: w({}, this.imageTransforms.flip),
          };
        if (this.src && this.imageLoaded) {
          ...
          return {
            image: this.image,
            coordinates: e,
            visibleArea: this.visibleArea ? w({}, this.visibleArea) : null,
            imageTransforms: t,
            get canvas() {
      ...
      zoom: function (e, t) {
        var n = (
          ...
          r = n === void 0 || n;
        this.onManipulateImage(new F({}, { factor: 1 / e, center: t }), {
          normalize: !1,
          transitions: r,
        });
      },
      move: function (e, t) {
        var n = (
          ...
          r = n === void 0 || n;
        this.onManipulateImage(new F({ left: e || 0, top: t || 0 }), {
          normalize: !1,
          transitions: r,
        });
      },
      setCoordinates: function (e) {
        ...
        this.$nextTick(function () {
          t.imageLoaded
            ? (t.transitionsActive ||
                (o && t.enableTransitions(),
                (t.coordinates = t.applyTransform(e)),
                i && t.runAutoZoom(`setCoordinates`),
                o && t.debouncedDisableTransitions()),
              t.onChange())
      ...
      prepareResult: function (e) {
        return this.roundResult
          ? (function (e) {
              ...
              return (
                i.width > n.maxWidth
                  ? (i.width = Math.floor(t.width))
                  : i.width < n.minWidth && (i.width = Math.ceil(t.width)),
                i.height > n.maxHeight
                  ? (i.height = Math.floor(t.height))
                  : i.height < n.minHeight && (i.height = Math.ceil(t.height)),
                X(i, r)
              );
            })(
              w(
                w({}, this.getPublicProperties()),
                {},
                {
                  positionRestrictions: Ot(
      ...
      processAutoZoom: function (e, t, n, r) {
        ...
        i ||= this.stencilSize ? xt : this.autoZoom ? St : Ct;
        var a = i({
          event: { type: e, params: r },
          visibleArea: t,
          coordinates: n,
          boundaries: this.boundaries,
        ...
        return w(
          w({}, a),
          {},
          { changed: !ut(a.visibleArea, t) || !ut(a.coordinates, n) },
        );
      },
      runAutoZoom: function (e) {
        var t =
          ...
          r = n !== void 0 && n,
          i = Re(t, ln),
          a = this.processAutoZoom(e, this.visibleArea, this.coordinates, i),
          o = a.visibleArea,
          s = a.coordinates,
          c = a.changed;
        (r && c && this.enableTransitions(),
          (this.visibleArea = o),
          (this.coordinates = s),
          r && c && this.debouncedDisableTransitions());
      },
      normalizeEvent: function (e) {
        return (function (e) {
          ...
          if (t.type === `resize`) {
            var i = A(A({}, t), { directions: A({}, t.directions) });
            return (
              I.forEach(function (e) {
                i.directions[e] *= r;
              }),
          ...
          if (t.type === `move`) {
            var a = A(A({}, t), { directions: A({}, t.directions) });
            return (
          ...
          return t;
        })(w(w({}, this.getPublicProperties()), {}, { event: e }));
      },
      getCanvas: function () {
        if (this.$refs.canvas) {
          var e = this.$refs.canvas,
            ...
            n =
              ...
              this.imageTransforms.flip.vertical
                ? (function (e, t, n) {
                    var r = n.rotate,
                      i = n.flip,
                      a = { width: t.naturalWidth, height: t.naturalHeight },
                      o = pt(a, r),
                      s = e.getContext(`2d`);
                    ((e.height = o.height), (e.width = o.width), s.save());
                    var c = J(z(A({ left: 0, top: 0 }, a)), r);
                    return (
                      s.translate(
                        -(c.left - o.width / 2),
                        -(c.top - o.height / 2),
                      ),
                      s.rotate((r * Math.PI) / 180),
                      s.translate(
                        i.horizontal ? a.width : 0,
                        i.vertical ? a.height : 0,
                      ),
                      s.scale(i.horizontal ? -1 : 1, i.vertical ? -1 : 1),
                      s.drawImage(t, 0, 0, a.width, a.height),
                      s.restore(),
                      e
                    );
            ...
            a = Q({
              sizeRestrictions: {
                ...
                maxWidth: i([r.width, r.maxWidth]) || 1 / 0,
                maxHeight: i([r.height, r.maxHeight]) || 1 / 0,
              },
          ...
          return (
            (function (e, t, n, r, i) {
              ((e.width = r ? r.width : n.width),
                (e.height = r ? r.height : n.height));
              var a = e.getContext(`2d`);
              (a.clearRect(0, 0, e.width, e.height),
                i &&
                  (i.imageSmoothingEnabled &&
                    (a.imageSmoothingEnabled = i.imageSmoothingEnabled),
                  i.imageSmoothingQuality &&
                    (a.imageSmoothingQuality = i.imageSmoothingQuality),
                  i.fillColor &&
                    ((a.fillStyle = i.fillColor),
                    a.fillRect(0, 0, e.width, e.height),
                    a.save())));
              var o = n.left < 0 ? -n.left : 0,
                s = n.top < 0 ? -n.top : 0;
              a.drawImage(
                t,
                n.left + o,
      ...
      applyTransform: function (e) {
        var t = arguments.length > 1 && arguments[1] !== void 0 && arguments[1],
          n =
            this.visibleArea && t
              ? ht(this.sizeRestrictions, this.visibleArea)
              : this.sizeRestrictions,
          r =
            this.visibleArea && t
              ? Ot(this.positionRestrictions, this.visibleArea)
              : this.positionRestrictions;
        return bt({
          transform: e,
      ...
      updateBoundaries: function () {
        ...
        return (
          ...
          this.$nextTick().then(function () {
            var t = { cropper: n, imageSize: e.imageSize };
            if (
              (j(e.defaultBoundaries)
                ? (e.boundaries = e.defaultBoundaries(t))
                : e.defaultBoundaries === `fit`
                  ? (e.boundaries = (function (e) {
                      var t = e.cropper,
                        n = e.imageSize,
                        r = t.clientHeight,
                        i = t.clientWidth,
              ...
              throw Error(
                `It's impossible to fit the cropper in the current container`,
              );
          })
        );
      },
      resetVisibleArea: function () {
        var e = this;
        return (
          (this.appliedImageTransforms = w(
            w({}, this.defaultImageTransforms),
            {},
            { flip: w({}, this.defaultImageTransforms.flip) },
          )),
          this.updateBoundaries()
            .then(function () {
              e.priority !== `visible-area` &&
                ((e.visibleArea = null), e.resetCoordinates());
              var t,
                n,
                r,
                i,
                a,
                o,
                s = e.defaultVisibleArea || Dt;
              ((e.visibleArea = j(s)
                ? s({
                    imageSize: e.imageSize,
                    boundaries: e.boundaries,
                    coordinates:
                      e.priority === `visible-area` ? null : e.coordinates,
                ...
                (e.visibleArea =
                  ...
                  (a = A({}, n)),
                  (o = G(r)),
                  a.width / a.height !== o && (a.height = a.width / o),
                  X(a, i({ visibleArea: a, type: `move` })))),
                e.priority === `visible-area`
                  ? e.resetCoordinates()
      ...
      onChangeImage: function () {
        var e,
          t = this;
        if (
          ((this.imageLoaded = !1), (this.delayedTransforms = null), this.src)
        ) {
          if (
            (function (e) {
              if (Ke(e)) return !1;
              var t = window.location,
                ...
                i = function (e) {
                  return (
                    e.port || ((e.protocol || t.protocol) === `http` ? 80 : 433)
                  );
                };
              return !(
                (!r.protocol && !r.host && !r.port) ||
                (r.protocol &&
            ...
            var n = M(this.crossOrigin) ? this.canvas : this.crossOrigin;
            (!0 === n && (n = `anonymous`),
              (this.imageAttributes.crossOrigin = n || null));
          }
              ...
              new Promise(function (t) {
                qt(e)
                  .then(function (n) {
                    ...
                    t(
                      n
                        ? { source: e, arrayBuffer: n, orientation: r }
                        : { source: e, arrayBuffer: null, orientation: null },
                    );
                  })
                  .catch(function (n) {
                    (console.warn(n),
                      t({ source: e, arrayBuffer: null, orientation: null }));
                  });
              }));
            setTimeout(function () {
      ...
      onParseImage: function (e) {
        ...
        (this.imageAttributes.revoke &&
          ...
          r && i && i > 1
            ? Ge(n) || !Ke(n)
              ? ((this.imageAttributes.src = URL.createObjectURL(
                  new Blob([r]),
                )),
                (this.imageAttributes.revoke = !0))
              : (this.imageAttributes.src = (function (e) {
                  for (var t = [], n = new Uint8Array(e); n.length > 0; ) {
                    var r = n.subarray(0, 8192);
                    (t.push(
                      String.fromCharCode.apply(
                        null,
                        Array.from ? Array.from(r) : r.slice(),
                      ),
                    ),
                      (n = n.subarray(8192)));
                  }
          ...
          j(this.defaultTransforms)
            ? (this.appliedImageTransforms = Kt(this.defaultTransforms()))
            : N(this.defaultTransforms)
              ? (this.appliedImageTransforms = Kt(this.defaultTransforms))
              : (this.appliedImageTransforms = (function (e) {
                  var t = Kt({});
                  if (e)
                    switch (e) {
                      case 2:
          ...
          (this.defaultImageTransforms = w(
            w({}, this.appliedImageTransforms),
            {},
            { flip: w({}, this.appliedImageTransforms.flip) },
          )),
          this.$nextTick(function () {
            var e = t.$refs.image;
            e &&
        ...
        this.transitionsOptions.enabled ||
          this.awaitRender(function () {
            ((t.coordinates = t.moveAlgorithm(
              w(
                w({}, t.getPublicProperties()),
                {},
                {
                  positionRestrictions: Ot(
                    t.positionRestrictions,
                    t.visibleArea,
                  ),
          ...
          var o = kt(
              w(
                ...
                {},
                {
                  ...
                  adjustStencil:
                    !this.stencilSize &&
                    this.settings.resizeImage.adjustStencil,
                },
              ),
            ),
            s = o.visibleArea,
      ...
      getAspectRatio: function (e) {
        ...
        if (
          ...
          var c = this.getStencilSize(),
            l = c ? G(c) : null;
          (M(t) && (t = Je(l) ? l : void 0), M(n) && (n = Je(l) ? l : void 0));
        }
      ...
      getStencilSize: function () {
        if (this.stencilSize)
          return (
            ...
            (n = e.stencilSize),
            (r = e.aspectRatio),
            dt(G((i = j(n) ? n({ boundaries: t, aspectRatio: r }) : n)), r) &&
              (i = Q({
                sizeRestrictions: {
                  maxWidth: t.width,
                  maxHeight: t.height,
                ...
                width: i.width,
                height: i.height,
                aspectRatio: { minimum: r.minimum, maximum: r.maximum },
              })),
            (i.width > t.width || i.height > t.height) &&
              (i = Q({
                ...
                width: i.width,
                height: i.height,
                aspectRatio: { minimum: G(i), maximum: G(i) },
              })),
            i
          );
        var e, t, n, r, i;
      ...
      flip: function (e, t) {
        ...
        if (!this.transitionsActive) {
          r && this.enableTransitions();
          var i = w({}, this.imageTransforms.flip),
            a = jt({
              flip: {
      ...
      rotate: function (e) {
        ...
        if (!this.transitionsActive) {
          ...
          var i = At({
            ...
            a = i.visibleArea,
            o = i.coordinates,
            s = this.processAutoZoom(`rotateImage`, a, o);
          ((a = s.visibleArea),
            (o = s.coordinates),
            (this.visibleArea = a),
            (this.coordinates = o),
  ...
  dn = { key: 0, ref: `canvas`, style: { display: `none` } },
  fn = { key: 1, ref: `sourceCanvas`, style: { display: `none` } };
un.render = function (t, i, a, o, s, l) {
  return (
    c(),
    b(
      `div`,
      { ref: `cropper`, class: l.classes.cropper },
      [
        e(`div`, { ref: `stretcher`, class: l.classes.stretcher }, null, 2),
        e(
          `div`,
          { class: l.classes.boundaries, style: l.boundariesStyle },
          [
            (c(),
            b(
              n(a.backgroundWrapperComponent),
              {
              ...
              },
              {
                default: d(function () {
                  return [
                    e(
                      `div`,
                      { class: l.classes.background, style: l.boundariesStyle },
                      null,
                      6,
                    ),
                    e(
                      `div`,
                      { class: l.classes.imageWrapper },
                      [
                        e(
                          `img`,
                          {
                    ...
                    e(
                      `div`,
                      { class: l.classes.foreground, style: l.boundariesStyle },
                      null,
                      6,
                    ),
                    r(
                    ...
                    a.canvas ? (c(), b(`canvas`, dn, null, 512)) : S(``, !0),
                    a.canvas ? (c(), b(`canvas`, fn, null, 512)) : S(``, !0),
                  ];
                }),
                _: 1,
              },
...
var pn = x({
    __name: `EditUserIcon`,
    emits: [`close`, `getNewIcon`],
    setup(e, { expose: t, emit: n }) {
      t();
      let r = C(),
        i = ie(),
        a = m({ img: null, size: `500x500`, outputType: `blob` }),
        o = m(null),
        s = ({ canvas: e }) => {
          e && (o.value = e.toDataURL(`image/png`));
        },
        c = n,
        l = {
          userProfileStore: r,
          ...
          setIconUrl: () => {
            o.value &&
              (r.setEditPrepareProfile({ iconUrl: o.value }), c(`close`));
          },
          dropImage: (e) => {
            if ((e.preventDefault(), !e.dataTransfer)) return;
            let t = e.dataTransfer.files[0];
            if (e.dataTransfer.files.length > 1) {
              i.showAlert(`2枚以上選択しないでください`, !0);
              return;
            }
            if (!t) return;
            if (!t.type.startsWith(`image/`)) {
              i.showAlert(`画像ファイルを選択してください`, !0);
              return;
            }
            let n = new FileReader();
            ((n.onload = (e) => {
              e.target && (a.value.img = e.target.result);
            }),
              n.readAsDataURL(t));
          },
          get Cropper() {
  ...
  mn = { class: `cropperArea` },
  hn = { style: { display: `flex`, "margin-left": `auto`, gap: `10px` } };
function gn(t, n, r, i, s, l) {
  return (
    c(),
    p(
      `div`,
      { class: `closeArea`, onClick: (n[5] ||= (e) => i.emit(`close`)) },
      [
        i.option.img
          ? (c(),
            p(
              ...
              [
                ...
                f(`section`, hn, [
                  e(
                    ...
                    {
                      variant: `ghost`,
                      onClick: (n[0] ||= (e) => i.emit(`close`)),
                    },
                    {
                      default: d(() => [...(n[6] ||= [a(`キャンセル`, -1)])]),
                      _: 1,
                    },
                  ),
                  e(
                    i.BaseButton,
                    { onClick: i.setIconUrl },
                    { default: d(() => [...(n[7] ||= [a(`確定`, -1)])]), _: 1 },
                  ),
                ]),
              ],
            ))
          : (c(),
            p(
              `div`,
              {
                key: 1,
                class: `DropArea`,
                onDrop: y(i.dropImage, [`prevent`]),
                onDragleave: (n[2] ||= y(() => {}, [`prevent`])),
                onDragover: (n[3] ||= y(() => {}, [`prevent`])),
                onClick: (n[4] ||= y(() => {}, [`stop`])),
              },
              [
                (n[9] ||= a(o(`画像をドロップ`) + ` `, -1)),
...
var _n = v(pn, [
    [`render`, gn],
    [`__scopeId`, `data-v-39f7275a`],
    [
      `__file`,
      `/Users/azumakoutaira/workspace/moti_nabi/frontend/src/features/profile/components/EditUserIcon.vue`,
    ],
  ]),
  vn = x({
    __name: `EditSnsurlTab`,
    props: { iconType: { type: String, required: !0 } },
    emits: [`close`, `setIconUrl`],
    setup(e, { expose: t, emit: n }) {
      t();
      let r = C(),
        i = m(``),
        a = e,
        o = () => {
          let e = r.getUserProfile.snsAcounts;
          (e.find((e) => {
            e.type === a.iconType && (e.link = i.value);
          }) && e.push({ type: a.iconType, link: i.value }),
            r.setEditPrepareProfile({ snsAcounts: e }),
            s(`close`));
        },
        s = n,
        c = {
  ...
  yn = { class: `tab` };
function bn(t, n, r, i, s, l) {
  return (
    c(),
    p(`div`, { class: `closeArea`, onClick: i.setIconUrl }, [
      f(`div`, yn, [
        (n[2] ||= a(o(`linkを入力`) + ` `, -1)),
        e(
          i.BaseInput,
          {
            onClick: (n[0] ||= y(() => {}, [`stop`])),
            modelValue: i.iconUrl,
            "onUpdate:modelValue": (n[1] ||= (e) => (i.iconUrl = e)),
            style: { "z-index": `20` },
          },
          null,
          8,
...
var xn = v(vn, [
    [`render`, bn],
    [`__scopeId`, `data-v-42fda487`],
    [
      `__file`,
      `/Users/azumakoutaira/workspace/moti_nabi/frontend/src/features/profile/components/EditSnsurlTab.vue`,
    ],
  ]),
  Sn = x({
    __name: `ProfileEdit`,
    ...
    setup(e, { expose: t }) {
      ...
      let n = C(),
        ...
        h = () => {
          (n.$dispose(),
            n.setEditPrepareProfile({ bio: u.value, name: d.value }),
            n.getEditPrepareProfile);
        };
      i(async () => {
        ((f.value = n.getUserProfile),
          (u.value = f.value?.bio || ``),
          (d.value = f.value?.name || ``));
      });
      let g = {
        userProfileStore: n,
        alertStore: r,
  ...
  Cn = `/svgicons/sns/instagram.svg`,
  wn = `/svgicons/sns/x.svg`,
  Tn = `/svgicons/sns/facebook.svg`,
  ...
  Fn = { class: `profile-description` },
  In = { class: `bio` },
  Ln = { class: `sns` },
  Rn = { class: `meta` },
  zn = { key: 1, class: `profile` };
function Bn(t, n, r, i, s, l) {
        ...
        f(`div`, Dn, [
          f(`section`, On, [
            f(`div`, kn, [
              f(
                `img`,
                { src: i.userProfile.iconUrl, class: `icon_image` },
                null,
                8,
                An,
              ),
              f(`div`, { class: `icon-edit`, onClick: i.onIconEdit }, [
                e(i.Camera, { fill: `white`, size: 100, color: `#1514143d` }),
              ]),
              i.editUserIconShow
                ? (c(),
                  b(i.EditUserIcon, {
                    key: 0,
                    onClose: (n[0] ||= (e) => (i.editUserIconShow = !1)),
                  }))
                : S(``, !0),
            ]),
            f(`div`, jn, [
              e(
                ...
                {
                  modelValue: i.name,
                  "onUpdate:modelValue": (n[1] ||= (e) => (i.name = e)),
                  class: `name`,
                },
                null,
                8,
              ...
              f(`div`, Mn, `@` + o(i.userProfile.userId), 1),
            ]),
          ]),
          f(`section`, Nn, [
            f(`div`, Pn, [
              ...
              e(
                i.BaseButton,
                { style: { "margin-left": `auto` }, onClick: i.pushEdit },
                {
                  default: d(() => [...(n[7] ||= [a(`変更を保存 `, -1)])]),
                  _: 1,
                },
              ),
            ]),
            f(`div`, Fn, [
              ...
              f(`div`, In, [
                e(
                  ...
                  {
                    modelValue: i.bio,
                    "onUpdate:modelValue": (n[2] ||= (e) => (i.bio = e)),
                  },
                  null,
                  8,
                  [`modelValue`],
              ...
              f(`div`, Ln, [
                f(`img`, {
                  ...
                  alt: `icon`,
                  class: `snsicon`,
                  onClick: (n[3] ||= (e) => i.onIcon(`instagram`)),
                }),
                f(`img`, {
                  src: wn,
                  alt: `icon`,
                  class: `snsicon`,
                  onClick: (n[4] ||= (e) => i.onIcon(`x`)),
                }),
                f(`img`, {
                  src: Tn,
                  alt: `icon`,
                  class: `snsicon`,
                  onClick: (n[5] ||= (e) => i.onIcon(`facebook`)),
                }),
                i.iconUrlTabShow
                  ? (c(),
                    b(
                      i.EditSnsurlTab,
                      {
                        key: 0,
                        iconType: i.iconType,
                        onClose: (n[6] ||= (e) => (i.iconUrlTabShow = !1)),
                      },
                      null,
                      8,
                      [`iconType`],
              ...
              f(`div`, Rn, [
                f(`span`, null, `📅 ` + o(i.userProfile.createdAt), 1),
                f(`span`, null, `📊 投稿数：` + o(i.userProfile.postCount), 1),
              ]),
            ]),
          ]),
        ]),
...
var Vn = v(Sn, [
    [`render`, Bn],
    [`__scopeId`, `data-v-48c8076d`],
    [
      `__file`,
      `/Users/azumakoutaira/workspace/moti_nabi/frontend/src/features/profile/components/ProfileEdit.vue`,
    ],
  ]),
  Hn = x({
  ...
  return (
    ...
    p(`div`, Un, [
      i.edit
        ? (c(),
          p(`div`, Wn, [
            e(i.ProfileEdit, { userId: i.userId }, null, 8, [`userId`]),
          ]))
        : (c(),
          p(`div`, Gn, [
            e(
              ...
              {
                userId: i.userId,
                modelValue: i.profile,
                "onUpdate:modelValue": (n[0] ||= (e) => (i.profile = e)),
              },
              null,
              8,
              [`userId`, `modelValue`],
      ...
      e(i.UserWorksPanel, { userId: i.userId }, null, 8, [`userId`]),
    ])
  );
}
var qn = v(Hn, [
