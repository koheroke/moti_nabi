...
import {
  ...
  o as b,
  u as se,
} from "./index-BVO_buEF.js";
import { t as ce } from "./userAuthStore-xgNHnAge.js";
import { t as le } from "./workPackageStore-tHUKCYeC.js";
...
var jt = `http://localhost:3000`,
  ...
  Bt = () => ({
    ...
    createNewWork: async (e) => {
      ...
      if ((console.log(`newWorkDatanewWorkData`, t), t == `error`)) return null;
      let n = await t.data.json();
      console.log(`newWorkData`, t);
      let r = { workName: t.workName, workId: t.workId, ...n };
      return (console.log(`workData`, r), t);
    },
  }),
  Vt = le(),
  $ = () => {
...
//# sourceMappingURL=Preview-CMSzPzUy.js.map
