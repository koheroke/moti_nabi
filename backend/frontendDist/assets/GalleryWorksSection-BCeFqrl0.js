...
import { i as u, l as d, n as f } from "./index-BRsJfEtE.js";
import { t as p } from "./userAuthStore-CNxB6aaV.js";
import { t as m } from "./workPackageStore-B69DCfcV.js";
import { n as h, t as g } from "./useIncrementalList-DQwTxeCu.js";
var _ = l({
    ...
    setup(e, { expose: t }) {
      t();
      let n = { WorksSection: h, BaseButton: u };
      return (
  ...
  y = { class: `box` };
function b(o, s, c, l, u, d) {
  return (
    n(),
    a(`section`, v, [
      i(`div`, y, [e(l.WorksSection, { works: c.works }, null, 8, [`works`])]),
      e(
        l.BaseButton,
        { variant: `text`, onClick: (s[0] ||= (e) => c.onMoreClick?.()) },
        { default: r(() => [...(s[1] ||= [t(` すべて見る → `, -1)])]), _: 1 },
      ),
    ])
  );
}
...
function C(e, t, r, i, a, o) {
  return (
    ...
    c(
      i.HomeWorksSection,
      { works: i.visibleItems, onMoreClick: i.onMoreClick },
      null,
      8,
      [`works`],
    )
