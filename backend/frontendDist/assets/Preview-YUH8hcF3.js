...
import {
  ...
  o as b,
  u as se,
} from "./index-C9R-8pie.js";
import { t as ce } from "./userAuthStore-UyFXNh54.js";
import { t as le } from "./workPackageStore-CzHPphK-.js";
  ...
  It = () => {
    ...
    let e = [],
      t = (t) => {
        ...
        (console.log(`ZushDBtoken`, n), e.length == 0 && r(), e.push(n));
      },
      n = () => {
        (console.log(`queue`, e), Pt.sendDb(e));
      },
      r = () => {
        setTimeout(() => {
          (n(), (e.length = 0));
...
//# sourceMappingURL=Preview-YUH8hcF3.js.map
