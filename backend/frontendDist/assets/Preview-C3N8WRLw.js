...
import { c as S, i as C, l as w, o as T } from "./index-CcOJc3N4.js";
import { t as E } from "./userAuthStore-DvGQb6jc.js";
import { t as D } from "./workPackageStore-Cfu5OCAR.js";
var O = T(`circle-minus`, [
  ...
  M = new WebSocket(`ws://localhost:3080`),
  ee = I(),
  te = j(),
  ne = () => ({
    sendAlteration: (e) => {
    ...
    sendDb: (e) => {
      let t = te.workIdGetter;
      M.send(
        JSON.stringify({ event: `work:save`, payload: { workId: t, data: e } }),
      );
    },
  });
((M.onmessage = (e) => {
...
var N = ne(),
  P = j(),
  F = () => {
    if (!P.workIdGetter == null) return;
    let e = [],
      t = (t) => {
        let n = {
          id: `id_${e.length}`,
          workId: P.workIdGetter,
          userId: t.user,
          type: t.token.type,
          path: t.token.path,
          beforeValue: null,
    ...
    let e = j(),
      ...
      a = async () => {
        ...
        return (
          ...
          V.selectWorkPackage(a.workId),
          `none`
        );
      },
      o = async () => {
        let t = V.selectedPackageIdGetter.id;
  ...
  G = { class: `header` },
  K = { class: `count` },
  q = { key: 0, class: `drop-text` };
function J(n, r, d, p, m, h) {
...
var Y = h(U, [
  ...
  ie = { class: `name` },
  ae = { class: `drop-area` },
  oe = { key: 0, style: { "font-size": `12px`, "text-align": `center` } };
function se(t, n, r, i, c, d) {
  return (
    s(),
    u(
      `div`,
      {
        class: b([`overlay`, [`overlay`, { close: i.isClose }]]),
...
var De = h(we, [
  ...
  ke = { class: `suitcase-wrap` },
  Ae = { viewBox: `0 0 400 560`, class: `suitcase` },
  je = [`x`, `y`, `width`, `height`],
  Me = [`x`, `y`, `width`, `height`],
  Ne = [`onDblclick`],
  Pe = [`x`, `y`, `width`, `height`],
...
var Le = h(Oe, [
  ...
  ze = { class: `preview-area` },
  Be = { class: `pocketModal` };
function Ve(t, n, r, i, a, c) {
  return (
    s(),
    u(`div`, ze, [
...
export { j as a, L as i, Q as n, H as r, He as t };
