...
import {
  ...
  s as oe,
  u as se,
} from "./index-DYprPpU6.js";
import { t as ce } from "./userAuthStore-CME0kFgs.js";
import { t as le } from "./workPackageStore-DHvOSWs7.js";
    ...
    actions: {
      ...
      pushpreviewItem(e) {
        ...
        if (e.parentId == null) t.items.set(n.id, n);
          ...
          if (r)
            return (r.set(n.id, n), { item: r.get(n.id), parent: e.parentId });
        }
        return (
          console.log(`pocket.items`, t.items),
          { item: t.items.get(n.id) }
        );
      },
      addBookmark(e) {
                ...
                Object.entries(t.pockets).map(([t, n]) => {
                  ...
                  return (
                    (a =
                      e.pockets == null
                        ? new Map()
                        : c(e.pockets[n.id]?.innerItems ?? new Map())),
                    [n.id, { ...n, ...i, items: a }]
                  );
                }),
              ),
            ...
            return (
              (e.pocketAdd ?? []).forEach((t) => {
                ...
                ((n =
                  e.pockets == null
                    ? new Map()
                    : c(e.pockets[t.id]?.innerItems ?? new Map())),
                  (r[t.id] = { ...t, items: n }));
              }),
              r
            );
    ...
    let e = S(),
      ...
      a = async () => {
        ...
        return (
          ...
          Wt.selectedPackageIdStore(a.workId),
          `none`
        );
      },
      o = async () => {
...
//# sourceMappingURL=Preview-CF0yOJrv.js.map
