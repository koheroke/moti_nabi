...
import {
  ...
  o as b,
  u as x,
} from "./index-CKhWhYkO.js";
import { t as se } from "./userAuthStore-40MrsVeM.js";
import { t as ce } from "./workPackageStore-Rs1B7zvM.js";
var le = b(`circle-minus`, [
...
var fe = { type: `error`, data: `parser error` },
  pe =
...
function be(e, t) {
  ...
  if (me && (e.data instanceof ArrayBuffer || he(e.data))) return t(ve(e.data));
  ge(e, !1, (e) => {
...
function ht(e, t) {
  ...
  if (B(e)) {
    ...
    for (let r = 0; r < e.length; r++) n[r] = ht(e[r], t);
    return n;
  } else if (typeof e == `object` && !(e instanceof Date)) {
    let n = {};
    for (let r in e)
      Object.prototype.hasOwnProperty.call(e, r) && (n[r] = ht(e[r], t));
    return n;
  }
  return e;
}
function gt(e, t) {
  return ((e.data = H(e.data, t)), delete e.attachments, e);
}
function H(e, t) {
  if (!e) return e;
  if (e && e._placeholder === !0) {
    ...
    for (let n = 0; n < e.length; n++) e[n] = H(e[n], t);
  else if (typeof e == `object`)
    for (let n in e)
      Object.prototype.hasOwnProperty.call(e, n) && (e[n] = H(e[n], t));
  return e;
}
var _t = x((e, t) => {
    var n = 1e3,
  ...
  U = (0, ie(yt()).default)(`socket.io-parser`),
  xt = [
    `connect`,
    `connect_error`,
    `disconnect`,
...
var St = class {
    ...
    encode(e) {
      return (
        ...
        (e.type === W.EVENT || e.type === W.ACK) && V(e)
          ? this.encodeAsBinary({
    ...
    encodeAsString(e) {
      let t = `` + e.type;
      return (
        (e.type === W.BINARY_EVENT || e.type === W.BINARY_ACK) &&
          (t += e.attachments + `-`),
        e.nsp && e.nsp !== `/` && (t += e.nsp + `,`),
        e.id != null && (t += e.id),
  ...
  Ct = class e extends k {
    ...
    add(e) {
      ...
      if (typeof e == `string`) {
        ...
        let n = t.type === W.BINARY_EVENT;
        n || t.type === W.BINARY_ACK
          ? ((t.type = n ? W.EVENT : W.ACK),
            (this.reconstructor = new wt(t)),
    ...
    decodeString(t) {
      ...
      if (W[r.type] === void 0) throw Error(`unknown packet type ` + r.type);
      if (r.type === W.BINARY_EVENT || r.type === W.BINARY_ACK) {
        ...
        if (i != Number(i) || t.charAt(n) !== `-`)
          throw Error(`Illegal attachments`);
        let a = Number(i);
        if (!Et(a) || a < 0) throw Error(`Illegal attachments`);
      ...
      switch (e) {
        ...
        case W.BINARY_EVENT:
          return (
            Array.isArray(t) &&
            (typeof t[0] == `number` ||
              (typeof t[0] == `string` && xt.indexOf(t[0]) === -1))
          );
        case W.ACK:
        case W.BINARY_ACK:
  ...
  wt = class {
    ...
    takeBinaryData(e) {
      if (
        ...
        let e = gt(this.reconPack, this.buffers);
...
function kt(e) {
  return Tt(e.nsp) && Dt(e.id) && Ot(e.type, e.data);
}
function K(e, t, n) {
  return (
    e.on(t, n),
  ...
  jt = class extends k {
    ...
    ack(e) {
      let t = this,
        n = !1;
      return function (...r) {
        n || ((n = !0), t.packet({ type: W.ACK, id: e, data: r }));
      };
    }
    onack(e) {
    ...
    socket(e, t) {
      ...
      return (
        n
          ...
          : ((n = new jt(this, e, t)), (this.nsps[e] = n)),
        n
      );
    }
    _destroy(e) {
...
function X(e, t) {
  ...
  let n = ct(e, t.path || `/socket.io`),
    ...
    c;
  return (
    s ? (c = new J(r, t)) : (Y[i] || (Y[i] = new J(r, t)), (c = Y[i])),
    n.query && !t.query && (t.query = n.queryKey),
    c.socket(n.path, t)
  );
}
Object.assign(X, { Manager: J, Socket: jt, io: X, connect: X });
...
var Ft = Pt(),
  ...
  $ = () => {
    let e = S(),
      ...
      o = async () => {
        let t = Ht.selectedPackageIdGetter;
...
export { S as a, Rt as i, an as n, $ as r, Bn as t };
//# sourceMappingURL=Preview-o0-sn3Og.js.map
