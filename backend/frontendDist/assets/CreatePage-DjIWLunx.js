...
import { a as D, i as O, n as k, r as A, t as ee } from "./Preview-DlL_ereD.js";
import { t as te } from "./search-CaFvMx3E.js";
import { t as j } from "./BaseButton-BOvMoO14.js";
import { a as M, o as N } from "./index-C2cro6hN.js";
import { t as P } from "./BaseInput-DMtlmy4F.js";
import { t as F } from "./UserIcon-BkM-2ece.js";
...
var mt = b(ct, [
  ...
  ht = S({
    ...
    setup(e, { expose: t }) {
      t();
      let n = I(),
        r = n.selectedPackageIdGetter.id,
        i = N(),
        o = A();
      a(async () => {
        let e = ``;
        switch (
          ((e =
            r.replaceAll(/\s+/g, ``).length == 0
              ? await o.createNewwork()
              : await o.loadWork()),
          e)
        ) {
          case `noneNameorWorkId`:
            i.showAlert(`ユーザー情報の取得に失敗しました`, !0);
            break;
          case `fallLoadData`:
            i.showAlert(`データの取得に失敗しました`, !0);
            break;
          case `damagedData`:
            i.showAlert(`データが破損しています`, !0);
            break;
          case `none`:
            i.showAlert(`読み込み完了`, !1);
            break;
          default:
            break;
        }
