...
import { t as h } from "./BaseButton-DE5dqd-G.js";
import { n as g, o as _ } from "./index-CLJEPiSW.js";
import { t as v } from "./userAuthstore-BSyaugSb.js";
var y = v(),
  b = `http://localhost:3000/auth/2fa`,
  x = async () =>
    await (
      await fetch(`${b}/setup`, {
        method: `POST`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify({ userId: y.userId, email: y.userEmail }),
      })
    ).json(),
  S = async (e) => {
    let t = await (
      await fetch(`${b}/verification`, {
        method: `POST`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify({ userId: y.userId, code: e }),
      })
    ).json();
    return (t && y.set2fa(), t);
  },
  ...
  U = r({
    ...
    setup: function (e) {
      var t = B(e),
        ...
        r = t.fgPath,
        i = t.imageProps,
        a = t.imageBorderProps,
        o = D(e.id),
        s = `qrcode.vue-gradient-${o}`,
        l = `qrcode.vue-logo-clip-path-${o}`,
        u = c(function () {
      ...
      return function () {
        return f(
          ...
          [
            f(`defs`, {}, [u.value, d.value]),
            f(`rect`, { width: `100%`, height: `100%`, fill: e.background }),
            f(`path`, {
              fill: e.gradient ? `url(#${s})` : e.foreground,
              d: r.value,
            }),
            a.value &&
              f(`rect`, {
            ...
            e.imageSettings.src &&
              ...
              f(
                `image`,
                C(
                  C({ href: e.imageSettings.src }, i.value),
                  i.value.borderRadius > 0 ? { "clip-path": `url(#${l})` } : {},
                ),
              ),
          ],
        );
    ...
    r({
      ...
      setup(t) {
        return (n, r) => (
          e(),
          l(`div`, K, [
            a(G, { value: t.grCode, size: 400, level: `H` }, null, 8, [
              `value`,
            ]),
          ])
        );
    ...
    r({
      ...
      setup(r, { emit: s }) {
        let c = s,
          ...
          f = i(),
          m = () => {
            u.value.length == Q && c(`completion:modelValue`, u.value);
          };
        return (
          n(() => {
            let e = navigator.userAgent.toLowerCase();
            e.indexOf(`iphone`) > 0 || e.indexOf(`ipad`) > 0
              ? (f.value = `https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=ja`)
              : e.indexOf(`android`) > 0
                ? (f.value = `https://apps.apple.com/jp/app/google-authenticator/id388497605`)
                : (f.value = `https://chromewebstore.google.com/detail/authenticator/bhghoamapcdpbohphigoooaddinpkbai?hl=ja`);
          }),
          (n, r) => {
            let i = p(`v-otp-input`);
            return (
              ...
              l(`div`, J, [
                d(`div`, Y, [
                  (r[2] ||= d(`h1`, null, `2段階認証の手順`, -1)),
                  d(`li`, null, [
                    d(`p`, null, [
                      d(`a`, { href: f.value }, `Google Authenticator`, 8, X),
                      (r[1] ||= o(`を使ってQRコードをよみとる `, -1)),
                    ]),
                  ]),
                  (r[3] ||= d(
                    `li`,
                    null,
                    [d(`p`, null, `表示された表示された6桁のコードを入力する`)],
                    -1,
                  )),
                ]),
                d(`div`, Z, [
    ...
    r({
      ...
      setup(t) {
        let r = g(),
          ...
          u = async (e) => {
            (await S(e))
              ? (o.showAlert(`2段階認証に成功しました`), r.push(`/home`))
              : o.showAlert(`2段階認証に失敗しました`, !0);
          };
        n(async () => {
          !d.isAuthenticated || d.isTempAuthenticated || (s.value = await x());
        });
        let d = v();
        return (t, n) => (
          e(),
          l(`div`, ee, [
            a(q, { "gr-code": s.value?.secretBase32 }, null, 8, [`gr-code`]),
            a(
              $,
              {
                modelValue: c.value,
