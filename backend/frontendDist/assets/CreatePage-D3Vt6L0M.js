...
import { a as E, i as D, n as ee, r as O, t as k } from "./Preview-BdRNcFtF.js";
import { t as te } from "./search-BEqCs7lL.js";
import { i as A, l as j, n as M, o as N, s as P } from "./index-0TfeJRPF.js";
import { t as F } from "./BaseInput-Du-FuUXE.js";
import "./BaseInput-BLkxjht9.js";
import { t as I } from "./userIconStore-Bp2pdMCy.js";
import { t as L } from "./UserIcon-DmjnBkm6.js";
import { t as R } from "./workPackageStore-yFfuitct.js";
var z = N(`boxes`, [
    [
      `path`,
      {
  ...
  K = { class: `topBar` },
  q = { class: `right` },
  J = { style: { gap: `10px`, display: `flex`, "margin-left": `auto` } },
  Y = { class: `left` },
  X = {
    class: `buttons`,
    style: {
    ...
    p(`div`, K, [
      f(`div`, q, [
        e(
          i.BaseInput,
          {
            modelValue: i.createStore.workNameGetter,
            "onUpdate:modelValue": (n[0] ||= (e) =>
              (i.createStore.workNameGetter = e)),
          },
          null,
          8,
          [`modelValue`],
        ...
        f(`div`, X, [
          e(
            i.UserIcon,
            {
              size: `medium`,
              userid: `a`,
              thumbnailUrl: i.userIconInfo.iconUrl,
          ...
          e(
            i.BaseButton,
            { variant: `ghost` },
            { default: d(() => [...(n[1] ||= [o(`招待`, -1)])]), _: 1 },
          ),
          e(
            i.BaseButton,
            { onClick: i.onpublich },
            { default: d(() => [...(n[2] ||= [o(`公開`, -1)])]), _: 1 },
          ),
        ]),
      ]),
    ])
...
var Q = b(G, [
  ...
  ne = S({
    ...
    setup(e, { expose: t }) {
      ...
      function l(e) {
        e.dataTransfer?.setData(`itemId`, r.item.itemId);
      }
      let u = {
        createWork: n,
        props: r,
  ...
  return (
    ...
    p(
      ...
      [
        ...
        f(`div`, ie, [f(`div`, ae, s(n.item.name), 1)]),
      ],
      34,
    )
  );
...
var se = b(ne, [
  ...
  ce = S({
    ...
    setup(e, { expose: t }) {
      t();
      let n = E(),
        { filteredListItem: r } = j(n),
        i = { createStore: n, filteredListItem: r, ItemCard: se };
      return (
    ...
    p(`div`, le, [
      ...
      p(
        ...
        c(
          ...
          (e) => (
            l(),
            x(r.ItemCard, { key: e.itemId, item: e }, null, 8, [`item`])
          ),
        ),
        128,
      )),
...
var he = b(fe, [
  ...
  _e = { class: `filteredItems` },
  ve = { class: `category-open` },
  ye = { class: `category-open-button` },
  be = { class: `category-list` },
  xe = { class: `category-item` };
...
var Ue = b(Le, [
  ...
  Ge = { viewBox: `0 0 400 560`, class: `suitcase` },
  Ke = [`x`, `y`, `width`, `height`],
  qe = [`x`, `y`, `width`, `height`],
  Je = [`x`, `y`, `width`, `height`],
  Ye = [`x`, `y`],
...
function st(t, n, r, i, a, o) {
  return (l(), p(`div`, at, [f(`div`, ot, [e(i.caseViewList)])]));
}
var ct = b(it, [
    [`render`, st],
  ...
  lt = S({
    ...
    setup(e, { expose: t }) {
      ...
      let n = {
        ...
        onSelect: (e) => {},
        sidebar: h([
          { id: `template`, name: `テンプレート`, onColor: `blue`, icon: H },
          { id: `item`, name: `持ち物`, onColor: `orange`, icon: z },
          { id: `case`, name: `ケース`, onColor: `green`, icon: U },
        ]),
        itemBar: Ue,
        caseSelectBar: ct,
      };
  ...
  ut = { class: `sideArea` },
  dt = { class: `sideBar list` },
  ft = { class: `flexCanter` },
  $ = [`onClick`],
  pt = { class: `selectContent` };
...
var ht = b(lt, [
  ...
  gt = S({
    ...
    setup(e, { expose: t }) {
      ...
      let n = R(),
        ...
        i = O();
      a(async () => {
        console.log(`onMounted`, n.selectedPackageIdGetter);
        let e = ``;
        switch (
          ((e =
            (n.selectedPackageIdGetter ?? ``).replaceAll(/\s+/g, ``).length ===
            0
  ...
  _t = { class: `page` },
  vt = { class: `main` },
  yt = { class: `sidebar-area` };
function bt(t, n, r, i, a, o) {
  return (
    l(),
    p(`div`, _t, [
      f(`header`, null, [e(i.TopBar, { title: `` })]),
      f(`main`, vt, [
        f(`div`, yt, [e(i.sideBar)]),
...
//# sourceMappingURL=CreatePage-D3Vt6L0M.js.map
