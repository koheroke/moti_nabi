...
import {
  ...
  o as y,
  u as b,
} from "./index-BPeTIfKB.js";
import { t as ce } from "./userAuthStore-B7U1MhqX.js";
import { t as le } from "./workPackageStore-YYyJ1dmZ.js";
var ue = y(`circle-minus`, [
...
var ht = b((e, t) => {
  ...
  yt = (0, ae(_t()).default)(`socket.io-parser`),
  bt = [
    `connect`,
    `connect_error`,
    `disconnect`,
...
var xt = class {
    ...
    encode(e) {
      return (
        yt(`encoding packet %j`, e),
        (e.type === G.EVENT || e.type === G.ACK) && H(e)
          ? this.encodeAsBinary({
  ...
  St = class e extends A {
    ...
    decodeString(t) {
      ...
      return (yt(`decoded %s as %j`, t, r), r);
    }
    tryParse(e) {
      try {
...
export { x as a, zt as i, on as n, $ as r, Vn as t };
