...
import { t as h } from "./_plugin-vue_export-helper-CXTkFu_Z.js";
import { t as g } from "./BaseButton-BuHe-3wu.js";
import { n as _, o as v } from "./index-C_uQkJjM.js";
import { t as y } from "./userAuthstore-y9warsrk.js";
var b = y(),
    ...
    setup: function (e) {
      ...
      return function () {
        return i(
          ...
          [
            i(`defs`, {}, [d.value, f.value]),
            i(`rect`, { width: `100%`, height: `100%`, fill: e.background }),
            i(`path`, {
                ...
                (P
                  ...
                  : s.value.forEach(function (e, t) {
                      e.forEach(function (e, n) {
                        e && v.fillRect(n + o.value, t + o.value, 1, 1);
                      });
                    }),
                e.imageSettings.src &&
                  y &&
      ...
      setup(e) {
        ...
        return (
          ...
          (n, r) => (
            t(),
            f(`div`, K, [
              o(G, { value: e.otpauthUrl, size: 350, level: `H` }, null, 8, [
                `value`,
              ]),
            ])
          )
    ...
    m({
      ...
      setup(n, { emit: i }) {
        let l = i,
          ...
          m = d(),
          h = () => {
            u.value.length == Q && l(`completion:modelValue`, u.value);
          };
        return (
          r(() => {
            let e = navigator.userAgent.toLowerCase();
            e.indexOf(`iphone`) > 0 || e.indexOf(`ipad`) > 0
              ? (m.value = `https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=ja`)
              : e.indexOf(`android`) > 0
                ? (m.value = `https://apps.apple.com/jp/app/google-authenticator/id388497605`)
                : (m.value = `https://chromewebstore.google.com/detail/authenticator/bhghoamapcdpbohphigoooaddinpkbai?hl=ja`);
          }),
          (n, r) => {
            let i = e(`v-otp-input`);
            return (
                ...
                p(`div`, Y, [
                  ...
                  p(`li`, null, [
                    p(`p`, null, [
                      ...
                      (r[1] ||= s(`を使ってQRコードを読み取る `, -1)),
                    ]),
                  ]),
                  (r[3] ||= c(
                    `<li data-v-f71f30a6><p data-v-f71f30a6>表示された6桁のコードを入力する</p></li><h3 style="margin-top:30px;" data-v-f71f30a6>Authenticator DL用QRコード</h3><section class="qrcode-section" data-v-f71f30a6><div class="qrcode" style="margin-right:auto;" data-v-f71f30a6><img src="/images/qr/authenticator-google.png" class="qr-image" data-v-f71f30a6><div data-v-f71f30a6>Andoroid用</div></div><div class="qrcode" style="margin-left:auto;" data-v-f71f30a6><img src="/images/qr/authenticator-apple.png" class="qr-image" data-v-f71f30a6> IOS/Apple用</div></section>`,
                    3,
                  )),
                ]),
                p(`div`, Z, [
                  ...
                  o(
                    g,
                    { class: `button`, onClick: h },
                    {
                      default: a(() => [...(r[4] ||= [s(`確認する`, -1)])]),
                      _: 1,
                    },
                  ),
                ]),
    ...
    m({
      ...
      setup(e) {
        let n = _(),
          ...
          s = d(``),
          c = S(),
          l = n.options.history.state.back,
          u = async (e) => {
            (await c.verification2fa(e))
        ...
        r(async () => {
          !p.isAuthenticated ||
            p.isTempAuthenticated ||
            (a.value = await c.setup());
        });
        let p = y();
        return (e, n) => (
          t(),
          f(`div`, ee, [
            o(q, { otpauthUrl: a.value?.otpauthUrl }, null, 8, [`otpauthUrl`]),
            o(
              $,
              {
                modelValue: s.value,
                "onUpdate:modelValue": (n[0] ||= (e) => (s.value = e)),
                "onCompletion:modelValue": u,
              },
              null,
              8,
              [`modelValue`],
