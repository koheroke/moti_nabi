...
import {
  ...
  s as oe,
  u as se,
} from "./index-DpYwUPON.js";
import { t as ce } from "./userAuthStore-DsKBNK1D.js";
import { t as le } from "./workPackageStore-Cm0Nwr3r.js";
...
var Mt = `http://localhost:3000`,
  ...
  Ht = `http://localhost:3000/work`,
  Ut = () => ({
    load: () => Vt,
    getWork: async (e) => {
      let t = await (
        await fetch(`${Ht}/getWork`, {
          method: `POST`,
  ...
  $ = () => {
    let e = S(),
      ...
      a = async () => {
        let n = t.userId,
          a = Wt.findPackage(n);
        if ((console.log(`thisPackage`, a), a == null)) return `nonePackage`;
        let o = null,
          s = {},
          c = {},
          l = 0;
        try {
          o = await r.createNewWork(n);
        } catch {
          return `fallLoadData`;
        }
        if (o == null) return `damagedData`;
        await Q().initCreateStaticData();
        let u = i.hydrateCreateState(o);
        ((s = u.vuepreviewData), (c = u.vueItemList), (l = u.addItemCounter));
        try {
          if ((console.log(`newWork`, o), o == null)) return `damagedData`;
          await Q().initCreateStaticData();
          let e = i.hydrateCreateState(o);
          ((s = e.vuepreviewData), (c = e.vueItemList), (l = e.addItemCounter));
        } catch {
          return `damagedData`;
        }
        return (
          e.setAddItemCounter(l),
          e.setSaveDBData(o),
          e.setlistItem(c),
          e.setpreviewData(s),
          e.setWorkId(a.id),
          e.setWorkName(a.name),
          Wt.selectedPackageIdStore(o.workId),
          `none`
        );
      },
      o = async () => {
        let t = Wt.selectedPackageIdGetter;
  ...
  qt = { class: `header` },
  Jt = { class: `count` },
  Yt = { key: 0, class: `drop-text` };
function Xt(n, r, d, p, m, h) {
...
var Zt = h(Gt, [
  ...
  tn = { class: `name` },
  nn = { class: `drop-area` },
  rn = { key: 0, style: { "font-size": `12px`, "text-align": `center` } };
function an(t, n, r, i, c, d) {
  return (
    s(),
    u(
      `div`,
...
var En = h(Cn, [
  ...
  On = { class: `suitcase-wrap` },
  kn = { viewBox: `0 0 400 560`, class: `suitcase` },
  An = [`x`, `y`, `width`, `height`],
  jn = [`x`, `y`, `width`, `height`],
  Mn = [`onDblclick`],
  Nn = [`x`, `y`, `width`, `height`],
...
var Ln = h(Dn, [
  ...
  zn = { class: `preview-area` },
  Bn = { class: `pocketModal` };
function Vn(t, n, r, i, a, c) {
  return (
    s(),
    u(`div`, zn, [
...
export { S as a, Bt as i, sn as n, $ as r, Hn as t };
//# sourceMappingURL=Preview-BVf84YUn.js.map
