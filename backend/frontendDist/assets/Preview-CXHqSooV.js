...
import {
  ...
  o as se,
  u as ce,
} from "./index-6c0JAOBd.js";
import { t as le } from "./userAuthStore-Hvwzbn0W.js";
import { t as ue } from "./workPackageStore-oZicNTvH.js";
var de = se(`circle-minus`, [
...
var gt = ce((e, t) => {
  ...
  W = (0, ie(vt()).default)(`socket.io-parser`),
  bt = [
    `connect`,
    `connect_error`,
    `disconnect`,
...
var Ft = Pt(),
  It = b(),
  Lt = () => {
    if (!It.workIdGetter == null) return;
    let e = [],
      t = (t) => {
        let n = {
          id: `id_${e.length}`,
          workId: It.workIdGetter,
          userId: t.user,
          type: t.token.type,
          path: t.token.path,
          beforeValue: null,
    ...
    let e = b(),
      ...
      a = async () => {
        ...
        return (
          ...
          Ht.selectWorkPackage(a.workId),
          `none`
        );
      },
      o = async () => {
        let t = Ht.selectedPackageIdGetter.id;
  ...
  Gt = { class: `header` },
  Kt = { class: `count` },
  qt = { key: 0, class: `drop-text` };
function Jt(n, r, d, p, m, h) {
...
var Yt = h(Ut, [
  ...
  $t = { class: `name` },
  en = { class: `drop-area` },
  tn = { key: 0, style: { "font-size": `12px`, "text-align": `center` } };
...
var wn = h(xn, [
  ...
  En = { class: `suitcase-wrap` },
  Dn = { viewBox: `0 0 400 560`, class: `suitcase` },
  On = [`x`, `y`, `width`, `height`],
  kn = [`x`, `y`, `width`, `height`],
  An = [`onDblclick`],
  jn = [`x`, `y`, `width`, `height`],
...
var Fn = h(Tn, [
  ...
  Ln = { class: `preview-area` },
  Rn = { class: `pocketModal` };
function zn(t, n, r, i, a, c) {
  return (
    s(),
    u(`div`, Ln, [
...
export { b as a, Rt as i, an as n, $ as r, Bn as t };
//# sourceMappingURL=Preview-CXHqSooV.js.map
