...
import { c as x, i as te, l as S, o as C } from "./index-CRPd98Uq.js";
import { t as w } from "./userAuthStore-CzJdSEOE.js";
import { t as T } from "./workPackageStore-BIdq4UOQ.js";
var E = C(`circle-minus`, [
  ...
  k = x(`create`, {
    ...
    actions: {
      ...
      pushpreviewItem(e) {
        if (
          (console.log(`token`, e),
          console.log(`this.previewCase`, this.previewCase),
          console.log(`this.listItem`, this.listItem),
          console.log(`this.addItemCounter`, this.addItemCounter),
  ...
  L = () => {
    let e = k(),
      ...
      o = async () => {
        let t = I.selectedPackageIdGetter.id;
