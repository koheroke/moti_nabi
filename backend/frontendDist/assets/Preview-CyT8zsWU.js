...
import {
  ...
  s as oe,
  u as se,
} from "./index-CPyXSq_i.js";
import { t as ce } from "./userAuthStore-C83_O01L.js";
import { t as le } from "./workPackageStore-DOdY8Esb.js";
  ...
  $ = () => {
    let e = S(),
      ...
      o = async () => {
        ...
        (await Q().initCreateStaticData(), i.hydrateCreateState(n));
        try {
          n = await r.getWork(t);
        } catch {
          return `fallLoadData`;
...
//# sourceMappingURL=Preview-CyT8zsWU.js.map
