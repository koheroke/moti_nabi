...
import {
  ...
  o as y,
  u as ce,
} from "./index-C1CtjlWM.js";
import { t as le } from "./userAuthStore-BbiYdDHW.js";
import { t as ue } from "./workPackageStore-CJ5pIalk.js";
var de = y(`circle-minus`, [
...
var C = { type: `error`, data: `parser error` },
  ...
  w = ({ type: e, data: t }, n, r) =>
    me && t instanceof Blob
      ? n
        ? r(t)
        : _e(t, r)
      : he && (t instanceof ArrayBuffer || ge(t))
        ? n
          ? r(t)
          : _e(new Blob([t]), r)
        : r(x[e] + (t || ``)),
...
var ye;
function be(e, t) {
  if (me && e.data instanceof Blob)
    return e.data.arrayBuffer().then(ve).then(t);
  if (he && (e.data instanceof ArrayBuffer || ge(e.data))) return t(ve(e.data));
  w(e, !1, (e) => {
    ((ye ||= new TextEncoder()), t(ye.encode(e)));
  });
}
var xe = `ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/`,
  T = typeof Uint8Array > `u` ? [] : new Uint8Array(256);
for (let e = 0; e < 64; e++) T[xe.charCodeAt(e)] = e;
var Se = (e) => {
    let t = e.length * 0.75,
      n = e.length,
      r,
    ...
    for (r = 0; r < n; r += 4)
      ((a = T[e.charCodeAt(r)]),
        ...
        (s = T[e.charCodeAt(r + 2)]),
        (c = T[e.charCodeAt(r + 3)]),
        (u[i++] = (a << 2) | (o >> 4)),
        (u[i++] = ((o & 15) << 4) | (s >> 2)),
        (u[i++] = ((s & 3) << 6) | (c & 63)));
    return l;
  ...
  E = (e, t) => {
    if (typeof e != `string`) return { type: `message`, data: Te(e, t) };
    let n = e.charAt(0);
    return n === `b`
      ? { type: `message`, data: we(e.substring(1), t) }
      : S[n]
        ? e.length > 1
  ...
  we = (e, t) => (Ce ? Te(Se(e), t) : { base64: !0, data: e }),
  Te = (e, t) => {
    switch (t) {
      case `blob`:
    ...
    transform(o, s) {
      for (n.push(o); ; ) {
        if (r === 0) {
          ...
          if (D(n) < i) break;
          let e = O(n, i);
          (s.enqueue(E(a ? e : Ae.decode(e), t)), (r = 0));
        }
        if (i === 0 || i > e) {
          s.enqueue(C);
          break;
...
function M(e, t) {
  t.useNativeTimers
    ? ((e.setTimeoutFn = Fe.bind(j)), (e.clearTimeoutFn = Ie.bind(j)))
    : ((e.setTimeoutFn = j.setTimeout.bind(j)),
      (e.clearTimeoutFn = j.clearTimeout.bind(j)));
}
var Le = 1.33;
function Re(e) {
  return typeof e == `string`
    ? ze(e)
    : Math.ceil((e.byteLength || e.size) * Le);
}
function ze(e) {
  let t = 0,
    n = 0;
...
var Ue = class extends Error {
  ...
  N = class extends k {
    ...
    onData(e) {
      let t = E(e, this.socket.binaryType);
      this.onPacket(t);
    }
    onPacket(e) {
...
if (((P.requestsCount = 0), (P.requests = {}), typeof document < `u`)) {
  ...
  et = class extends N {
    ...
    uri() {
      let e = this.opts.secure ? `wss` : `ws`,
        t = this.query || {};
      return (
        this.opts.timestampRequests && (t[this.opts.timestampParam] = Be()),
        this.supportsBinary || (t.b64 = 1),
        this.createUri(e, t)
      );
    }
  },
  F = j.WebSocket || j.MozWebSocket,
  tt = {
    websocket: class extends et {
      createSocket(e, t, n) {
        return $e ? new F(e, t, n) : t ? new F(e, t) : new F(e);
      }
      doWrite(e, t) {
        this.ws.send(t);
      }
    },
    webtransport: class extends N {
      get name() {
        return `webtransport`;
      }
      doOpen() {
        ...
        (this._transport.closed
          ...
          this._transport.ready.then(() => {
            this._transport.createBidirectionalStream().then((e) => {
              let t = je(2 ** 53 - 1, this.socket.binaryType),
  ...
  return (
    n != -1 &&
      ...
      (a.authority = a.authority
        ...
        .replace(/;/g, `:`)),
      (a.ipv6uri = !0)),
    (a.pathNames = it(a, a.path)),
    (a.queryKey = at(a, a.query)),
    a
  );
}
function it(e, t) {
...
var z = class e extends k {
  constructor(e, t) {
    ...
    (M(this, t),
      ...
      typeof this.opts.query == `string` &&
        (this.opts.query = He(this.opts.query)),
      L &&
  ...
  _getWritablePackets() {
    ...
    for (let t = 0; t < this.writeBuffer.length; t++) {
      ...
      if ((n && (e += Re(n)), t > 0 && e > this._maxPayload))
            ...
            if (!n)
              if (e.type === `pong` && e.data === `probe`) {
                if (
                  ...
                  return;
                ((z.priorWebsocketSuccess = t.name === `websocket`),
...
var lt = typeof ArrayBuffer == `function`,
  ut = (e) =>
    typeof ArrayBuffer.isView == `function`
      ? ArrayBuffer.isView(e)
  ...
  ft =
    typeof Blob == `function` ||
    (typeof Blob < `u` && dt.call(Blob) === `[object BlobConstructor]`),
  pt =
    typeof File == `function` ||
    (typeof File < `u` && dt.call(File) === `[object FileConstructor]`);
function B(e) {
  return (
    (lt && (e instanceof ArrayBuffer || ut(e))) ||
    (ft && e instanceof Blob) ||
    (pt && e instanceof File)
  );
}
function V(e, t) {
  if (!e || typeof e != `object`) return !1;
  if (Array.isArray(e)) {
    for (let t = 0, n = e.length; t < n; t++) if (V(e[t])) return !0;
    return !1;
  }
  if (B(e)) return !0;
  if (e.toJSON && typeof e.toJSON == `function` && arguments.length === 1)
    return V(e.toJSON(), !0);
  for (let t in e)
    if (Object.prototype.hasOwnProperty.call(e, t) && V(e[t])) return !0;
  return !1;
}
function mt(e) {
  let t = [],
...
function H(e, t) {
  ...
  if (B(e)) {
    ...
    for (let r = 0; r < e.length; r++) n[r] = H(e[r], t);
    return n;
  } else if (typeof e == `object` && !(e instanceof Date)) {
    let n = {};
    for (let r in e)
      Object.prototype.hasOwnProperty.call(e, r) && (n[r] = H(e[r], t));
    return n;
  }
  return e;
}
function ht(e, t) {
  return ((e.data = U(e.data, t)), delete e.attachments, e);
}
function U(e, t) {
  if (!e) return e;
  if (e && e._placeholder === !0) {
    ...
    for (let n = 0; n < e.length; n++) e[n] = U(e[n], t);
  else if (typeof e == `object`)
    for (let n in e)
      Object.prototype.hasOwnProperty.call(e, n) && (e[n] = U(e[n], t));
  return e;
}
var gt = ce((e, t) => {
    var n = 1e3,
  ...
  W = (0, ae(vt()).default)(`socket.io-parser`),
  bt = [
    `connect`,
    `connect_error`,
    `disconnect`,
...
var xt = class {
    ...
    encode(e) {
      return (
        W(`encoding packet %j`, e),
        (e.type === G.EVENT || e.type === G.ACK) && V(e)
          ? this.encodeAsBinary({
    ...
    encodeAsString(e) {
      let t = `` + e.type;
      return (
        (e.type === G.BINARY_EVENT || e.type === G.BINARY_ACK) &&
          (t += e.attachments + `-`),
        e.nsp && e.nsp !== `/` && (t += e.nsp + `,`),
        e.id != null && (t += e.id),
        e.data != null && (t += JSON.stringify(e.data, this.replacer)),
        W(`encoded %j as %s`, e, t),
        t
      );
    }
    encodeAsBinary(e) {
  ...
  St = class e extends k {
    ...
    add(e) {
      ...
      if (typeof e == `string`) {
        ...
        let n = t.type === G.BINARY_EVENT;
        n || t.type === G.BINARY_ACK
          ? ((t.type = n ? G.EVENT : G.ACK),
            (this.reconstructor = new Ct(t)),
            t.attachments === 0 && super.emitReserved(`decoded`, t))
          : super.emitReserved(`decoded`, t);
      } else if (B(e) || e.base64)
        if (this.reconstructor)
    ...
    decodeString(t) {
      ...
      if (G[r.type] === void 0) throw Error(`unknown packet type ` + r.type);
    ...
    static isPayloadValid(e, t) {
      switch (e) {
        ...
        case G.CONNECT_ERROR:
          return typeof t == `string` || K(t);
        case G.EVENT:
        case G.BINARY_EVENT:
          return (
            Array.isArray(t) &&
            (typeof t[0] == `number` ||
              (typeof t[0] == `string` && bt.indexOf(t[0]) === -1))
          );
        case G.ACK:
        case G.BINARY_ACK:
  ...
  Ct = class {
    ...
    takeBinaryData(e) {
      if (
        ...
        let e = ht(this.reconPack, this.buffers);
...
function Ot(e) {
  return wt(e.nsp) && Et(e.id) && Dt(e.type, e.data);
}
function q(e, t, n) {
  return (
    e.on(t, n),
  ...
  At = class extends k {
    ...
    ack(e) {
      let t = this,
        n = !1;
      return function (...r) {
        n || ((n = !0), t.packet({ type: G.ACK, id: e, data: r }));
      };
    }
    onack(e) {
    ...
    socket(e, t) {
      ...
      return (
        n
          ...
          : ((n = new At(this, e, t)), (this.nsps[e] = n)),
        n
      );
    }
    _destroy(e) {
...
function X(e, t) {
  ...
  let n = ct(e, t.path || `/socket.io`),
    ...
    c;
  return (
    s ? (c = new jt(r, t)) : (Y[i] || (Y[i] = new jt(r, t)), (c = Y[i])),
    n.query && !t.query && (t.query = n.queryKey),
    c.socket(n.path, t)
  );
}
Object.assign(X, { Manager: jt, Socket: At, io: X, connect: X });
var Mt = `http://localhost:3000`,
  Nt = b(),
  Z = X(Mt),
  Pt = Q(),
  Ft = () => ({
    sendAlteration: (e) => {
      Z.emit(`work:alteration`, e);
    },
    sendDb: (e) => {
      Z.emit(`work:save`, { workId: Nt.workIdGetter, data: e });
    },
  });
(Z.on(`work:alteration`, (e) => {
  Pt.alterationData(e);
}),
  Z.on(`work:userJoin`, () => {
    console.log(`join`);
...
var It = Ft(),
  Lt = b(),
  Rt = () => {
    if (!Lt.workIdGetter == null) return;
    let e = [],
      t = (t) => {
        let n = {
          id: `id_${e.length}`,
          workId: Lt.workIdGetter,
          userId: t.user,
          type: t.token.type,
          path: t.token.path,
          beforeValue: null,
    ...
    let e = b(),
      ...
      a = async () => {
        ...
        return (
          ...
          Ut.selectWorkPackage(a.workId),
          `none`
        );
      },
      o = async () => {
        let t = Ut.selectedPackageIdGetter.id;
  ...
  Kt = { class: `header` },
  qt = { class: `count` },
  Jt = { key: 0, class: `drop-text` };
function Yt(n, r, d, p, m, h) {
...
var Xt = h(Wt, [
  ...
  en = { class: `name` },
  tn = { class: `drop-area` },
  nn = { key: 0, style: { "font-size": `12px`, "text-align": `center` } };
...
var Tn = h(Sn, [
  ...
  Dn = { class: `suitcase-wrap` },
  On = { viewBox: `0 0 400 560`, class: `suitcase` },
  kn = [`x`, `y`, `width`, `height`],
  An = [`x`, `y`, `width`, `height`],
  jn = [`onDblclick`],
  Mn = [`x`, `y`, `width`, `height`],
...
var In = h(En, [
  ...
  Rn = { class: `preview-area` },
  zn = { class: `pocketModal` };
function Bn(t, n, r, i, a, c) {
  return (
    s(),
    u(`div`, Rn, [
...
export { b as a, zt as i, on as n, $ as r, Vn as t };
