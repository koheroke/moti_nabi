...
import { t as te } from "./BaseButton-BQpTzNib.js";
import { a as C } from "./index-DMA70-bn.js";
import { t as w } from "./userAuthstore-D9vDWqWh.js";
var T = C(`circle-minus`, [
...
var M = () => {
  ...
  F = `http://localhost:3000/create`,
  I = () => ({
    load: () => P,
    getWork: async (e, t) =>
      await (
        await fetch(`${F}/work/get`, {
          method: `POST`,
          headers: { "Content-Type": `application/json` },
          body: JSON.stringify({ userId: e, theWorkId: t }),
        })
      ).json(),
    pushWork: async (e, t) =>
      await (
        await fetch(`${F}/work/push`, {
          method: `POST`,
          headers: { "Content-Type": `application/json` },
          body: JSON.stringify({ userId: e, theWorkId: t }),
        })
...
export { O as a, N as i, Q as n, L as r, Le as t };
