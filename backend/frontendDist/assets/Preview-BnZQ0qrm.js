...
import {
  ...
  s as oe,
  u as se,
} from "./index-CfrV-YAn.js";
import { t as ce } from "./userAuthStore-BfMBedAW.js";
import { t as le } from "./workPackageStore-DqKY3u-6.js";
  ...
  Q = () => {
    ...
    return {
      ...
      alterationData: (n) => {
        ...
        e.push({
          user: n.user,
          alterationType: n.alterationType,
          token: r.value,
        });
      },
    ...
    let e = S(),
      ...
      a = async () => {
        ...
        return (
          ...
          Wt.selectWorkPackage(a.workId),
          `none`
        );
      },
      o = async () => {
        let t = Wt.selectedPackageIdGetter.id;
...
//# sourceMappingURL=Preview-BnZQ0qrm.js.map
