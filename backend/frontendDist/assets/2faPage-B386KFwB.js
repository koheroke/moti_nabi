...
import { n as _, o as v } from "./index-CtTbV4JC.js";
...
var H = {
    ...
    margin: { type: Number, required: !1, default: j },
    imageSettings: {
      type: Object,
      required: !1,
      default: function () {
          ...
          [
            ...
            e.imageSettings.src &&
              ...
              i(
                `image`,
                w(
                  w({ href: e.imageSettings.src }, a.value),
      ...
      setup(e) {
        ...
        return (
          ...
          (n, r) => (
            t(),
            f(`div`, q, [
              o(K, { value: e.otpauthUrl, size: 400, level: `H` }, null, 8, [
                `value`,
              ]),
            ])
          )
    ...
    m({
      ...
      setup(n, { emit: i }) {
        let l = i,
          ...
          m = d(),
          h = () => {
            u.value.length == $ && l(`completion:modelValue`, u.value);
          };
        return (
          r(() => {
                ...
                p(`div`, X, [
                  ...
                  p(`li`, null, [
                    p(`p`, null, [
                      ...
                      (r[1] ||= s(`を使ってQRコードをよみとる `, -1)),
                    ]),
                  ]),
                  (r[3] ||= c(
                    `<section class="qrcode-section" data-v-4d694d48><div class="qrcode" data-v-4d694d48><img src="/images/qr/authenticator-google.png" class="qr-image" data-v-4d694d48> GoogleStore_URL</div><div class="qrcode" data-v-4d694d48><img src="/images/qr/authenticator-apple.png" class="qr-image" data-v-4d694d48> AppleStore_URL</div></section><li data-v-4d694d48><p data-v-4d694d48>表示された表示された6桁のコードを入力する</p></li>`,
                    2,
                  )),
                ]),
                p(`div`, Q, [
      ...
      setup(e) {
        let n = _(),
          ...
          c = async (e) => {
            console.log(c);
            let t = await C(e);
            (console.log(`verificationBool` + t),
              t
                ? (i.showAlert(`2段階認証に成功しました`), n.push(`/home`))
                : i.showAlert(`2段階認証に失敗しました`, !0));
          };
        r(async () => {
          !l.isAuthenticated || l.isTempAuthenticated || (a.value = await S());
        });
        let l = y();
        return (e, n) => (
          t(),
          f(`div`, te, [
            o(J, { otpauthUrl: a.value?.otpauthUrl }, null, 8, [`otpauthUrl`]),
            o(
              ee,
              {
                modelValue: s.value,
                "onUpdate:modelValue": (n[0] ||= (e) => (s.value = e)),
                "onCompletion:modelValue": c,
              },
              null,
              8,
              [`modelValue`],
