...
import { t as g } from "./BaseButton-BOvMoO14.js";
import { n as _, o as v } from "./index-9brz4ZpC.js";
...
var V = {
    ...
    setup: function (e) {
      ...
      return function () {
        return t(
          ...
          [
            t(`defs`, {}, [u.value, d.value]),
            t(`rect`, { width: `100%`, height: `100%`, fill: e.background }),
            t(`path`, {
      ...
      var i = B(e),
        ...
        _ = function () {
          var t = e.size,
            ...
            i = e.gradient,
            o = e.gradientType,
            u = e.gradientStartColor,
            d = e.gradientEndColor,
            _ = m.value;
          if (_) {
  ...
  q = { class: `left` };
function J(t, n, r, i, o, s) {
  return (
    a(),
    l(`div`, q, [
      e(i.QrcodeVue, { value: r.otpauthUrl, size: 350, level: `H` }, null, 8, [
        `value`,
      ]),
    ])
  );
...
var Y = p(K, [
  ...
  ee = [`href`],
  te = { class: `bottom` };
function ne(t, r, o, u, d, f) {
  let p = n(`v-otp-input`);
  return (
    a(),
    l(`div`, Q, [
      c(`div`, $, [
        (r[2] ||= c(`h1`, null, `2段階認証の手順`, -1)),
        c(`li`, null, [
          c(`p`, null, [
            c(
              `a`,
              { target: `_blank`, href: u.href },
              `Google Authenticator`,
              8,
              ee,
            ),
            (r[1] ||= i(`を使ってQRコードを読み取る `, -1)),
          ]),
        ]),
        (r[3] ||= h(
      ...
      c(`div`, te, [
        e(
          ...
          {
            modelValue: u.otp,
            "onUpdate:modelValue": (r[0] ||= (e) => (u.otp = e)),
            length: u.otpLength,
            variant: `outlined`,
            type: `number`,
            class: `custom-otp`,
        ...
        e(
          u.BaseButton,
          { class: `button`, onClick: u.onOtp },
          { default: s(() => [...(r[4] ||= [i(`確認する`, -1)])]), _: 1 },
        ),
      ]),
    ])
  );
...
var re = p(Z, [
  ...
  ae = { class: `page` };
function oe(t, n, r, i, o, s) {
  return (
    a(),
    l(`div`, ae, [
      e(i.SplitQr2fa, { otpauthUrl: i.use2faResponse?.otpauthUrl }, null, 8, [
        `otpauthUrl`,
      ]),
      e(
        i.AuthProcedureScreen,
        {
          modelValue: i.otp,
          "onUpdate:modelValue": (n[0] ||= (e) => (i.otp = e)),
          "onCompletion:modelValue": i.sendOtp,
        },
        null,
        8,
        [`modelValue`],
