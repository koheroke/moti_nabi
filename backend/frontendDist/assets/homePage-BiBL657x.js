...
import { r as l } from "./pinia-DB58mGSn.js";
import { t as u } from "./BaseButton-BOvMoO14.js";
import { n as d } from "./index-C2cro6hN.js";
import { t as f } from "./userAuthstore-CclVSd_h.js";
import { t as p } from "./UserIcon-BkM-2ece.js";
import { t as m } from "./workPackageStore-CHuZhDEm.js";
import { t as h } from "./useIncrementalList-B3KkqNCv.js";
import { n as g, t as _ } from "./GalleryWorksSection-iE27h9YW.js";
var v = c({
  ...
  setup(e, { expose: t }) {
    ...
    let n = m(),
      r = f(),
      { userWorkPackageStoreGetter: i } = l(n),
...
var b = o(v, [
    ...
    setup(e, { expose: t }) {
      ...
      let n = d(),
        ...
        i = {
          ...
          testUserId: x,
          goCreate: () => {
            (r.selectWorkPackage(``), n.push(`/create`));
          },
  ...
  O = { class: `container` },
  k = { class: `container` };
function A(o, s, c, l, u, d) {
  return (
    n(),
    a(`div`, C, [
      i(`header`, w, [
        (s[0] ||= i(`h1`, null, `motinabi`, -1)),
        e(l.UserIcon, { userid: l.testUserId, size: `large` }),
      ]),
      i(`body`, T, [
        i(`section`, E, [
          i(`section`, D, [
        ...
        i(`section`, O, [
          ...
          e(l.MyWorksSection, { userId: l.testUserId, class: `content` }),
        ]),
        (s[6] ||= i(
          `section`,
          { class: `container` },
