...
import {
  ...
  s as oe,
  u as se,
} from "./index-CkN_T6GQ.js";
import { t as ce } from "./userAuthStore-DibqH2xF.js";
import { t as le } from "./workPackageStore-BtKg46Hx.js";
    ...
    let e = S(),
      ...
      o = async () => {
        let t = Wt.selectedPackageIdGetter,
          n = Wt.findPackage(t);
        if ((console.log(`thisPackage`, n), !t)) return `noneNameorWorkId`;
        let a = null,
          o = {},
          s = {},
          c = 0;
        ...
        try {
          if ((console.log(`data`, a), a == null)) throw Error();
          await Q().initCreateStaticData();
          let e = i.hydrateCreateState(a);
          ((o = e.vuepreviewData), (s = e.vueItemList), (c = e.addItemCounter));
        } catch {
...
//# sourceMappingURL=Preview-BWlTDWSn.js.map
