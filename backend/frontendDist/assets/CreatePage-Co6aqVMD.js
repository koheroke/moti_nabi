...
import { r as ee } from "./pinia-BDLqBGc_.js";
import { a as E, i as D, n as O, r as k, t as te } from "./Preview-Capgx0Ss.js";
import { t as A } from "./search-Bw_i_maS.js";
import { t as j } from "./BaseButton-DgJxAwXf.js";
import { a as M, o as N } from "./index-BWdytgOe.js";
import { t as P } from "./BaseInput-DJX8DiWo.js";
import { t as F } from "./UserIcon-U7D_LATZ.js";
var I = M(`boxes`, [
    [
      `path`,
      {
  ...
  U = { class: `topBar` },
  W = { class: `right` },
  G = { style: { color: `black`, "font-size": `35px`, "font-weight": `400` } },
  K = { style: { gap: `10px`, display: `flex`, "margin-left": `auto` } },
  q = { class: `left` },
  J = {
    class: `buttons`,
    style: {
...
function Y(t, n, r, i, a, s) {
  return (
    ...
    w(`div`, U, [
      h(`div`, W, [
        h(`div`, G, C(i.props.title), 1),
        h(`div`, K, [
          o(i.CornerUpLeft, { onClick: i.back }),
          o(i.CornerUpRight, { onClick: i.forward }),
        ]),
      ]),
      h(`div`, q, [
        h(`div`, J, [
          ...
          o(
            i.BaseButton,
            { variant: `ghost` },
            { default: l(() => [...(n[0] ||= [S(`招待`, -1)])]), _: 1 },
          ),
          o(i.BaseButton, null, {
            default: l(() => [...(n[1] ||= [S(`公開`, -1)])]),
            _: 1,
          }),
        ]),
      ]),
...
function ie(t, n, r, i, a, o) {
  return (
    ...
    w(
      `div`,
      {
        class: x([`item-card`, { storage: r.item.isStorage }]),
        draggable: `true`,
      ...
      [
        ...
        h(
          `div`,
          { class: `item-icon`, style: f({ color: i.categoryColor }) },
          C(i.icon.src),
          5,
        ),
        h(`div`, ne, [h(`div`, re, C(r.item.name), 1)]),
      ],
      34,
    )
  );
...
var ae = y(Z, [
  ...
  oe = t({
    ...
    setup(e, { expose: t }) {
      t();
      let n = E(),
        { filteredListItem: r } = ee(n),
        i = { createStore: n, filteredListItem: r, ItemCard: ae };
      return (
    ...
    w(`div`, se, [
      ...
      w(
        ...
        r(
          ...
          (t) => (
            e(),
            d(a.ItemCard, { key: t.id, item: t }, null, 8, [`item`])
          ),
        ),
        128,
      )),
...
var le = y(oe, [
  ...
  de = { class: `container` };
function fe(t, n, r, i, a, s) {
  return (
    e(),
    w(`div`, de, [
      o(i.Search, { color: `white`, size: 25 }),
      o(
        i.BaseInput,
        {
...
var pe = y(ue, [
  ...
  he = { class: `filteredItems` },
  ge = { class: `category-open` },
  _e = { class: `category-open-button` },
  ve = { class: `category-list` },
  ye = { class: `category-item` };
function be(t, n, i, a, s, c) {
  return (
    e(),
    w(`div`, he, [
      h(`section`, ge, [
        ...
        o(
          ...
          {
            onClick: (n[0] ||= (e) =>
              a.props.categorys?.[a.props.index]?.id &&
              a.onCategory(a.props.categorys[a.props.index].id)),
          },
          {
            default: l(() => [
              h(`section`, _e, [
                h(`div`, null, C(a.currentCategory?.name), 1),
                h(`div`, null, C(a.currentCategory?.icon), 1),
              ]),
            ]),
            _: 1,
          },
              ...
              w(`div`, { key: t.id }, [
                o(
                  ...
                  },
                  {
                    default: l(() => [
                      h(`section`, ye, [
                        h(`div`, null, C(t.name), 1),
                        h(`div`, null, C(t.icon), 1),
                      ]),
                    ]),
                    _: 2,
                  },
  ...
  Se = t({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      let r = E(),
        ...
        a = r.categories,
        o = e,
        s = g(() => a.find((e) => e.id == o.selectedCategory)?.name),
        c = Object.entries(i).map(([e, t]) => ({ id: e, ...t })),
        l = g(() => c.filter((e) => e.category == o.selectedCategory)),
        u = n,
        d = {
          createStore: r,
          iconMap: i,
...
function Ee(t, n, i, a, o, s) {
  return (
    ...
    w(`div`, Ce, [
      ...
      h(`div`, null, C(`今選ばれているカテゴリー` + a.categoryName), 1),
      h(`section`, we, [
        (e(!0),
        w(
          m,
          ...
          r(
            ...
            (t) => (
              ...
              w(`div`, null, [
                h(
                  `div`,
                  { class: `icon`, onClick: (e) => a.onIcon(t.id) },
                  C(t.src),
                  9,
                  Te,
                ),
...
var De = y(Se, [
  ...
  Oe = t({
    ...
    setup(e, { expose: t, emit: n }) {
      ...
      let g = () => {
          if (!S.value || !l.value || !f.value) return;
          let e = {
            name: S.value,
            category: [l.value],
            ...
            [
              ...
              h(`section`, Ae, [
                o(
                  m,
                  {
                    modelValue: i.selectedCategory,
                    "onUpdate:modelValue": (n[1] ||= (e) =>
                      (i.selectedCategory = e)),
                    items: r.categories,
                    "item-title": `name`,
                    "item-value": `id`,
                    label: `カテゴリーを選択`,
                  ...
                  {
                    item: l(({ props: e }) => [o(f, T(s(e)), null, 16)]),
                    _: 1,
                  },
                  8,
                  [`modelValue`, `items`],
                ...
                o(
                  i.BaseButton,
                  {
                    ...
                    onClick: i.iconSelectToggle,
                    variant: `ghost`,
                  },
                  {
                    default: l(() => [
                      S(C(i.selectedIcoSrc) + ` アイコンを選択`, 1),
                    ]),
                    _: 1,
                  },
                ),
                u(
                  o(
                    i.iconSelect,
                    {
                      ...
                      onClose: i.closeIconSelect,
                      iconId: i.selectedIcon,
                      "onUpdate:iconId": (n[2] ||= (e) => (i.selectedIcon = e)),
                      class: x({
                        popup: i.iconSelectOpen,
                        popdown: !i.iconSelectOpen,
                      }),
                    },
                    null,
                    8,
              ...
              h(`section`, je, [
                h(`label`, Me, [
                  ...
                  (n[6] ||= S(` ` + C(`アイテムを収納にする`), -1)),
                ]),
              ]),
              o(
                i.BaseButton,
                { onClick: i.onAddItem },
                { default: l(() => [...(n[7] ||= [S(`追加`, -1)])]), _: 1 },
              ),
            ],
            2,
          ),
...
function Be(t, n, r, i, a, s) {
  return (
    ...
    w(`div`, Ie, [
      ...
      h(`section`, ze, [
        (n[3] ||= h(`div`, { class: `title` }, C(`持ち物一覧`), -1)),
        o(
          i.addItem,
          {
...
var Ve = y(Fe, [
  ...
  Ue = { viewBox: `0 0 400 560`, class: `suitcase` },
  We = [`x`, `y`, `width`, `height`],
  Ge = [`x`, `y`, `width`, `height`],
  Ke = [`x`, `y`, `width`, `height`],
  qe = [`x`, `y`],
  Je = [`x`, `y`];
function Ye(t, n, i, a, o, s) {
  return (
    e(),
    w(
      `div`,
        ...
        w(`svg`, Ue, [
          h(
            `rect`,
            {
              x: a.props.case.x,
              y: a.props.case.y,
              width: a.props.case.width,
              height: a.props.case.height,
              class: `case-body`,
              rx: `14`,
            },
            null,
          ...
          h(
            `rect`,
            {
              x: a.props.handle.x,
              y: a.props.handle.y,
              width: a.props.handle.width,
              height: a.props.handle.height,
              rx: `12`,
              class: `handle`,
            },
            null,
          ...
          w(
            ...
            r(
              ...
              (t) => (
                e(),
                w(`g`, { key: t.id, class: `pocket-group` }, [
                  h(
                    `rect`,
                    {
                      x: t.x,
              ...
              h(`div`, $e, [
                o(
                  a.Casecard,
                  {
                    ...
                    name: t.data.name,
                    id: t.id,
                    selectedPocket: a.cases,
                    "onUpdate:selectedPocket": (n[0] ||= (e) => (a.cases = e)),
...
var tt = y(Ze, [
  ...
  rt = { class: `case-bar` },
  it = { class: `bar` };
function at(t, n, r, i, a, s) {
  return (e(), w(`div`, rt, [h(`div`, it, [o(i.caseViewList)])]));
}
var ot = y(nt, [
    [`render`, at],
  ...
  st = t({
    ...
    setup(e, { expose: t }) {
      t();
      let n = {
        selectedId: v(`template`),
        onSelect: (e) => {},
        sidebar: v([
          { id: `template`, name: `テンプレート`, onColor: `blue`, icon: z },
          { id: `item`, name: `持ち物`, onColor: `orange`, icon: I },
          { id: `case`, name: `ケース`, onColor: `green`, icon: B },
        ]),
        itemBar: Ve,
        caseSelectBar: ot,
      };
  ...
  ct = { class: `sideArea` },
  lt = { class: `sideBar list` },
  ut = { class: `flexCanter` },
  dt = [`onClick`],
  ft = { class: `selectContent` };
function $(t, i, a, o, s, c) {
  return (
    e(),
    w(`div`, ct, [
      h(`div`, lt, [
                ...
                h(`section`, ut, [
                  h(
                    `div`,
                    {
                      ...
                      onClick: (e) => {
                        (o.onSelect(t.id), (o.selectedId = t.id));
                      },
      ...
      h(`div`, ft, [
        o.selectedId == `item` ? (e(), d(o.itemBar, { key: 0 })) : b(``, !0),
        o.selectedId == `case`
          ? (e(), d(o.caseSelectBar, { key: 1 }))
          : b(``, !0),
      ]),
    ])
  );
...
var pt = y(st, [
  ...
  mt = t({
    ...
    setup(e, { expose: t }) {
      ...
      let n = N(),
        r = k();
      a(async () => {
        switch (await r.loadWork()) {
          case `noneNameorWorkId`:
            n.showAlert(`ユーザー情報の取得に失敗しました`, !0);
            break;
          case `fallLoadData`:
            n.showAlert(`データの取得に失敗しました`, !0);
            break;
          case `damagedData`:
            n.showAlert(`データが破損しています`, !0);
            break;
          case `none`:
            n.showAlert(`読み込み完了`, !1);
            break;
          default:
            break;
        }
  ...
  ht = { class: `page` },
  gt = { class: `main` },
  _t = { class: `sidebar-area` };
function vt(t, n, r, i, a, s) {
  return (
    e(),
    w(`div`, ht, [
      h(`header`, null, [o(i.TopBar, { title: `` })]),
      h(`main`, gt, [
        h(`div`, _t, [o(i.sideBar)]),
        o(i.Preview, { type: `hard` }),
      ]),
    ])
  );
}
