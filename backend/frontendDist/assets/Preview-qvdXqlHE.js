...
import {
  ...
  o as x,
  u as S,
} from "./index-MFsTCba-.js";
import { t as oe } from "./userAuthStore-BUWaKCm2.js";
import { t as se } from "./workPackageStore-BMNuxP8h.js";
var ce = x(`circle-minus`, [
...
var de = { type: `error`, data: `parser error` },
  fe =
    typeof Blob == `function` ||
    (typeof Blob < `u` &&
      Object.prototype.toString.call(Blob) === `[object BlobConstructor]`),
  pe = typeof ArrayBuffer == `function`,
  me = (e) =>
    typeof ArrayBuffer.isView == `function`
      ? ArrayBuffer.isView(e)
      : e && e.buffer instanceof ArrayBuffer,
  he = ({ type: e, data: t }, n, r) =>
    fe && t instanceof Blob
      ? n
        ? r(t)
        : ge(t, r)
      : pe && (t instanceof ArrayBuffer || me(t))
        ? n
          ? r(t)
          : ge(new Blob([t]), r)
        : r(w[e] + (t || ``)),
...
var ve;
function ye(e, t) {
  if (fe && e.data instanceof Blob)
    return e.data.arrayBuffer().then(_e).then(t);
  if (pe && (e.data instanceof ArrayBuffer || me(e.data))) return t(_e(e.data));
  he(e, !1, (e) => {
...
var ht = S((e, t) => {
  ...
  G = (0, re(_t()).default)(`socket.io-parser`),
  yt = [
    `connect`,
    `connect_error`,
    `disconnect`,
...
var jt = C(),
  Mt = Z(`http://localhost:3000`);
Q();
var Nt = () => ({
  sendAlteration: (e) => {
    Mt.send(
      JSON.stringify({ event: `work:alteration`, payload: JSON.stringify(e) }),
    );
  },
  sendDb: (e) => {
    let t = jt.workIdGetter;
    Mt.send(
...
var Pt = Nt(),
  ...
  $ = () => {
    let e = C(),
      ...
      o = async () => {
        let t = Vt.selectedPackageIdGetter;
...
export { C as a, Lt as i, rn as n, $ as r, zn as t };
