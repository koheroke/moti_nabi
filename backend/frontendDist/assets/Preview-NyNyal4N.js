...
import {
  ...
  s as oe,
  u as se,
} from "./index-Dh6JwWUz.js";
import { t as ce } from "./userAuthStore-BMH18QTJ.js";
import { t as le } from "./workPackageStore-CoZhMlGz.js";
  ...
  Ut = () => ({
    ...
    getWork: async (e) => {
      let t = await (
        ...
        n = JSON.parse(t.data);
      console.log(`parse`, n);
      let r = { ...n.data, workName: n.workName, workId: n.workId };
      return (console.log(`parse`, r), r);
    },
...
//# sourceMappingURL=Preview-NyNyal4N.js.map
