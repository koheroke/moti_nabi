...
import {
  ...
  o as b,
  u as se,
} from "./index-Btq96QEk.js";
import { t as ce } from "./userAuthStore-BSUk9nRb.js";
import { t as le } from "./workPackageStore-glKmty6i.js";
...
var jt = `http://localhost:3000`,
  ...
  Bt = () => ({
    ...
    createNewWork: async (e) => {
      ...
      let n = { workName: t.workName, workId: t.workId, ...t.data };
      return (console.log(`workData`, n), t);
    },
  }),
  Vt = le(),
  $ = () => {
...
//# sourceMappingURL=Preview-Bbo30RZ2.js.map
