...
import { a as E, i as D, n as ee, r as O, t as k } from "./Preview-1eDvOtey.js";
import { t as te } from "./search-DAU8dUWu.js";
import { i as A, l as j, n as M, o as N, s as P } from "./index-COdq92lb.js";
import { t as F } from "./BaseInput-Du-FuUXE.js";
import "./BaseInput-BLkxjht9.js";
import { t as I } from "./UserIcon-Ce5M5GCC.js";
import { t as L } from "./workPackageStore-_rduQiQV.js";
var R = N(`boxes`, [
    [
      `path`,
      {
  ...
  ct = S({
    ...
    setup(e, { expose: t }) {
      ...
      let n = {
        ...
        onSelect: (e) => {},
        sidebar: h([
          { id: `template`, name: `テンプレート`, onColor: `blue`, icon: V },
          { id: `item`, name: `持ち物`, onColor: `orange`, icon: R },
          { id: `case`, name: `ケース`, onColor: `green`, icon: H },
        ]),
        itemBar: He,
        caseSelectBar: st,
      };
