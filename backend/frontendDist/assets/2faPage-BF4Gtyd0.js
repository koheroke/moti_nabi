...
import { n as _, o as v } from "./index-RQ-0Morp.js";
  ...
  J = h(
    m({
      ...
      setup(e) {
        ...
        return (
          r(() => {
            console.log(`grCode:` + n.grCode);
          }),
          (n, r) => (
            t(),
            f(`div`, q, [
              o(K, { value: e.grCode, size: 400, level: `H` }, null, 8, [
                `value`,
              ]),
            ])
          )
    ...
    m({
      ...
      setup(e) {
        ...
        return (e, n) => (
          t(),
          f(`div`, te, [
            o(J, { "gr-code": a.value?.secretBase32 }, null, 8, [`gr-code`]),
            o(
              ee,
              {
                modelValue: s.value,
