...
import { a as p, t as m } from "./index-Ck1BRSx1.js";
import { t as h } from "./userAuthstore-y9warsrk.js";
import { n as ee, t as g } from "./useIncrementalList-C6_B5B9h.js";
import { t as _ } from "./GalleryWorksSection-CNcZJ-OB.js";
var v = p(`camera`, [
    [
      `path`,
      {
              ...
              l(`div`, w, [
                u(`div`, T, [
                  u(`section`, E, [
                    u(
                      `img`,
                      { src: s.value.iconUrl, class: `icon` },
                      null,
                      8,
                      D,
                    ),
                    u(`div`, O, [
                      u(`div`, k, n(s.value.name), 1),
                      u(`div`, A, `@` + n(s.value.id), 1),
                    ]),
                  ]),
                  u(`section`, j, [
                    (i[1] ||= u(
                    ...
                    u(`div`, M, [
                      ...
                      u(`div`, L, [
                        u(`span`, null, `📅 ` + n(s.value.createdAt), 1),
                        u(
                          `span`,
                          null,
                          `📊 投稿数：` + n(s.value.postCount),
                          1,
                        ),
                      ]),
                    ]),
    ...
    d({
      ...
      setup(t) {
        ...
        return (t, r) => (
          e(),
          l(`div`, B, [
            i(_, { works: s(n), onMoreClick: a }, null, 8, [`works`]),
          ])
        );
      },
    }),
                ...
                l(`div`, U, [
                  u(`div`, W, [
                    u(`section`, G, [
                      ...
                      u(`div`, Y, [
                        u(`div`, X, n(f.value.name), 1),
                        u(`div`, Z, `@` + n(f.value.id), 1),
                      ]),
                    ]),
                    u(`section`, Q, [
                      (c[1] ||= u(
                      ...
                      u(`div`, ne, [
                        ...
                        u(`div`, $, [
                          u(`span`, null, `📅 ` + n(f.value.createdAt), 1),
                          u(
                            `span`,
                            null,
    ...
    d({
      ...
      setup(t) {
        let n = h(),
          ...
          a = c(),
          o = r.query.edit,
          u = Array.isArray(r.params.userId)
            ? r.params.userId[0]
            : r.params.userId,
          d = c(u == n.userId ? o : !1);
        return (t, n) => (
          ...
          l(`div`, le, [
            d.value
              ? (e(),
                l(`div`, ue, [i(ce, { userId: s(u) }, null, 8, [`userId`])]))
              : (e(),
                l(`div`, de, [
                  i(
                    z,
